...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_consulta']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_consulta"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_excluir_consulta = false;
function sc_btn_excluir_consulta()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_excluir_consulta(); }, 500);
      return;
    }
...
function sc_btn_excluir_consulta_ok()
{
    Crtl_btn_excluir_consulta = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?excluir_consulta?@?";
    document.F1.action = "./";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_consulta']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("status_id=disabled", "I");
