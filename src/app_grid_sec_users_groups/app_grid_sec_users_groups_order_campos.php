<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_com210.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["matricula"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["matricula"] : "" . $this->Nm_lang['lang_sec_users_fild_login'] . "";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["nome"] : "" . $this->Nm_lang['lang_sec_users_fild_name'] . "";
   ...
   $tab_labels["ativo"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["ativo"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["ativo"] : "" . $this->Nm_lang['lang_sec_users_fild_active'] . "";
