...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nome
  function do_ajax_app_form_sec_apps_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_apps_mob_validate_nome(var_nome, var_script_case_init, do_ajax_app_form_sec_apps_mob_validate_nome_cb);
  } // do_ajax_app_form_sec_apps_mob_validate_nome

  function do_ajax_app_form_sec_apps_mob_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_apps_mob_validate_nome_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_sec_apps_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_apps_mob_submit_form(var_nome, var_descricao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_sec_apps_mob_submit_form_cb);
...
?>
  ...
  function perform_ajax_app_form_sec_apps_mob_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("nome");
    scAjaxHideErrorDisplay("descricao");
    var var_nome = document.F2.nome.value;
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_apps_mob_navigate_form(var_nome, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_sec_apps_mob_navigate_form_cb);
...
?>
  function do_ajax_app_form_sec_apps_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.nome.value = scAjaxGetKeyValue("nome");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
?>
  ...
  var ajax_error_list = {
    "nome": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_app_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
