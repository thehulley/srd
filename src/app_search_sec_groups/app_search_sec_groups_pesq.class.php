...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['campos_busca']['id_cond']; 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id'])) ? $this->New_label['id'] : "" . $this->Ini->Nm_lang['lang_list_groups'] . ""; ?></TD>
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id" <?php echo $str_hide_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id'])) ? $this->New_label['id'] : "" . $this->Ini->Nm_lang['lang_list_groups'] . "";
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['psq_check_ret']['id'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['psq_check_ret']['id'][] = trim($rs->fields[0]);
...
<?php
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['psq_check_ret']['id'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['campos_busca']['id_cond'] = $id_cond_salva; 
