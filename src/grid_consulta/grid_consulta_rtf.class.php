...
class grid_consulta_rtf
{
   ...
   function NM_export_medico_id()
   {
         ...
         $this->look_medico_id = str_replace('<', '&lt;', $this->look_medico_id);
         $this->look_medico_id = str_replace('>', '&gt;', $this->look_medico_id);
         $this->Texto_tag .= "<td>" . $this->look_medico_id . "</td>\r\n";
   }
   //----- motivo
   ...
   function NM_export_outras_infomacoes()
   {
         ...
         $this->outras_infomacoes = str_replace('<', '&lt;', $this->outras_infomacoes);
         $this->outras_infomacoes = str_replace('>', '&gt;', $this->outras_infomacoes);
         $this->Texto_tag .= "<td>" . $this->outras_infomacoes . "</td>\r\n";
   }
   //----- data_consulta
   function NM_export_data_consulta()
   {
         ...
         $this->data_consulta = str_replace('>', '&gt;', $this->data_consulta);
         $this->Texto_tag .= "<td>" . $this->data_consulta . "</td>\r\n";
   }
   //----- status_id
