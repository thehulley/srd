...
class grid_consulta_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_consulta.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta']['rtf_name']);
      }
   ...
   function NM_export_c_detento_id()
   {
         ...
         $this->look_c_detento_id = str_replace('<', '&lt;', $this->look_c_detento_id);
         $this->look_c_detento_id = str_replace('>', '&gt;', $this->look_c_detento_id);
         $this->Texto_tag .= "<td>" . $this->look_c_detento_id . "</td>\r\n";
   }
   //----- c_medico_id
   function NM_export_c_medico_id()
   {
         ...
         $this->look_c_medico_id = str_replace('<', '&lt;', $this->look_c_medico_id);
         $this->look_c_medico_id = str_replace('>', '&gt;', $this->look_c_medico_id);
         $this->Texto_tag .= "<td>" . $this->look_c_medico_id . "</td>\r\n";
   }
   //----- c_data_consulta
   function NM_export_c_data_consulta()
   {
         ...
         $this->c_data_consulta = str_replace('<', '&lt;', $this->c_data_consulta);
         $this->c_data_consulta = str_replace('>', '&gt;', $this->c_data_consulta);
         $this->Texto_tag .= "<td>" . $this->c_data_consulta . "</td>\r\n";
   }
   //----- c_motivo
   function NM_export_c_motivo()
   {
         ...
         $this->c_motivo = str_replace('<', '&lt;', $this->c_motivo);
         $this->c_motivo = str_replace('>', '&gt;', $this->c_motivo);
         $this->Texto_tag .= "<td>" . $this->c_motivo . "</td>\r\n";
   }
   //----- c_outras_infomacoes
   function NM_export_c_outras_infomacoes()
   {
         ...
         $this->c_outras_infomacoes = str_replace('<', '&lt;', $this->c_outras_infomacoes);
         $this->c_outras_infomacoes = str_replace('>', '&gt;', $this->c_outras_infomacoes);
         $this->Texto_tag .= "<td>" . $this->c_outras_infomacoes . "</td>\r\n";
   }
   //----- c_status_id
   function NM_export_c_status_id()
   {
         ...
         $this->look_c_status_id = str_replace('<', '&lt;', $this->look_c_status_id);
         $this->look_c_status_id = str_replace('>', '&gt;', $this->look_c_status_id);
         $this->Texto_tag .= "<td>" . $this->look_c_status_id . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_consulta']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> consulta :: RTF</TITLE>
