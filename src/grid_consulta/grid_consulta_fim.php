...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["com210_____grid_consulta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["com210_____grid_consulta"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_consulta'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_consulta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_consulta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_consulta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_consulta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_consulta']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_consulta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_consulta']['embutida_filho'] as $ind => $sc_init)
          {
