<?php
@session_start() ;
$_SESSION['scriptcase']['grid_visita']['sc_process_barr'] = true;
require_once('../grid_visita/index.php');
unset($_SESSION['scriptcase']['grid_visita']['sc_process_barr']);
$ExportCtrl = new grid_visita_export_control;
$ExportCtrl->Export_barr();

class grid_visita_export_control
{
