...
class grid_visita_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_visita_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_visita_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_visita_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "data_nascimento";$Nm_datas[] = "data_nascimento";$Nm_datas[] = "data_visita";$Nm_datas[] = "data_visita";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> visita</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_visita/grid_visita_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_visita_ajax_search.js"></script>
 <script type="text/javascript" src="grid_visita_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_visita_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_visita']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_visita']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_data_nascimento_cond#NMF#' + search_get_sel_txt('SC_data_nascimento_cond') + '@NMF@';
  str_out += 'SC_data_nascimento_dia#NMF#' + search_get_sel_txt('SC_data_nascimento_dia') + '@NMF@';
  str_out += 'SC_data_nascimento_mes#NMF#' + search_get_sel_txt('SC_data_nascimento_mes') + '@NMF@';
  str_out += 'SC_data_nascimento_ano#NMF#' + search_get_sel_txt('SC_data_nascimento_ano') + '@NMF@';
  str_out += 'SC_data_nascimento_input_2_dia#NMF#' + search_get_sel_txt('SC_data_nascimento_input_2_dia') + '@NMF@';
  str_out += 'SC_data_nascimento_input_2_mes#NMF#' + search_get_sel_txt('SC_data_nascimento_input_2_mes') + '@NMF@';
  str_out += 'SC_data_nascimento_input_2_ano#NMF#' + search_get_sel_txt('SC_data_nascimento_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> visita</div>
...
<?php
   ...
   {
      global 
             $data_nascimento_cond, $data_nascimento, $data_nascimento_dia, $data_nascimento_mes, $data_nascimento_ano, $data_nascimento_input_2_dia, $data_nascimento_input_2_mes, $data_nascimento_input_2_ano,
             $id_cond, $id,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $data_nascimento_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_dia']; 
          $data_nascimento_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_mes']; 
          $data_nascimento_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_ano']; 
          $data_nascimento_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_input_2_dia']; 
          $data_nascimento_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_input_2_mes']; 
          $data_nascimento_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_input_2_ano']; 
          $data_nascimento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['id_cond']; 
          $nome = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['nome']; 
          $nome_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['nome_cond']; 
          $cpf = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['cpf']; 
          $cpf_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['cpf_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['NM_operador']; 
      ...
      if (!isset($data_nascimento_cond) || empty($data_nascimento_cond))
      {
         $data_nascimento_cond = "eq";
      }
      ...
      $str_hide_data_nascimento = (in_array($data_nascimento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_data_nascimento = ('bw' == $data_nascimento_cond) ? $display_aberto : $display_fechado;
      $str_display_id = ('bw' == $id_cond) ? $display_aberto : $display_fechado;
      $str_display_nome = ('bw' == $nome_cond) ? $display_aberto : $display_fechado;
      $str_display_cpf = ('bw' == $cpf_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($data_nascimento, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $data_nascimento = substr($data_nascimento, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_data_nascimento_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['data_nascimento'])) ? $this->New_label['data_nascimento'] : "Data de Nascimento"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_data_nascimento_cond" name="data_nascimento_cond" onChange="nm_campos_between(document.getElementById('id_vis_data_nascimento'), this, 'data_nascimento')">
       <OPTION value="eq" <?php if ("eq" == $data_nascimento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $data_nascimento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $data_nascimento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $data_nascimento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_data_nascimento" <?php echo $str_hide_data_nascimento?> valign="top">
 ...
 $nmgp_tab_label .= "data_nascimento?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_data_nascimento_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_nascimento_dia" name="data_nascimento_dia" value="<?php echo NM_encode_input($data_nascimento_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_nascimento_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_nascimento_mes" name="data_nascimento_mes" value="<?php echo NM_encode_input($data_nascimento_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_nascimento_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_nascimento_ano" name="data_nascimento_ano" value="<?php echo NM_encode_input($data_nascimento_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_data_nascimento"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_data_nascimento"  <?php echo $str_display_data_nascimento; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_data_nascimento_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_nascimento_input_2_dia" name="data_nascimento_input_2_dia" value="<?php echo NM_encode_input($data_nascimento_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_nascimento_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_nascimento_input_2_mes" name="data_nascimento_input_2_mes" value="<?php echo NM_encode_input($data_nascimento_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_nascimento_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_nascimento_input_2_ano" name="data_nascimento_input_2_ano" value="<?php echo NM_encode_input($data_nascimento_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
<INPUT  type="text" id="SC_nome" name="nome" value="<?php echo NM_encode_input($nome) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nome" name="nome_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cpf_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cpf'])) ? $this->New_label['cpf'] : "CPF"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cpf_cond" name="cpf_cond" onChange="nm_campos_between(document.getElementById('id_vis_cpf'), this, 'cpf')">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cpf" name="cpf_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_visita_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_visita']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_visita']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.data_nascimento_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_data_nascimento'), document.F1.data_nascimento_cond, 'data_nascimento');
   document.F1.data_nascimento_dia.value = "";
   document.F1.data_nascimento_mes.value = "";
   document.F1.data_nascimento_ano.value = "";
   document.F1.data_nascimento_input_2_dia.value = "";
   document.F1.data_nascimento_input_2_mes.value = "";
   document.F1.data_nascimento_input_2_ano.value = "";
 ...
 {
    $('#SC_data_nascimento_dia').bind('change', function() {sc_grid_visita_valida_dia(this)});
    $('#SC_data_nascimento_input_2_dia').bind('change', function() {sc_grid_visita_valida_dia(this)});
    $('#SC_data_nascimento_input_2_mes').bind('change', function() {sc_grid_visita_valida_mes(this)});
    $('#SC_data_nascimento_mes').bind('change', function() {sc_grid_visita_valida_mes(this)});
 }
 function sc_grid_visita_valida_dia(obj)
 {
 ...
 function sc_grid_visita_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_data_nascimento_cond'] = 'cond';
      $tp_fields['SC_data_nascimento_dia'] = 'text';
      $tp_fields['SC_data_nascimento_mes'] = 'text';
      $tp_fields['SC_data_nascimento_ano'] = 'text';
      $tp_fields['SC_data_nascimento_input_2_dia'] = 'text';
      $tp_fields['SC_data_nascimento_input_2_mes'] = 'text';
      $tp_fields['SC_data_nascimento_input_2_ano'] = 'text';
   ...
   {
      global $data_nascimento_cond, $data_nascimento, $data_nascimento_dia, $data_nascimento_mes, $data_nascimento_ano, $data_nascimento_input_2_dia, $data_nascimento_input_2_mes, $data_nascimento_input_2_ano,
             $id_cond, $id,
             $nome_cond, $nome, $nome_autocomp,
             $cpf_cond, $cpf, $cpf_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq'] = array();
      ...
      $data_nascimento_cond_salva = $data_nascimento_cond; 
      if (!isset($data_nascimento_input_2_dia) || $data_nascimento_input_2_dia == "")
      {
          $data_nascimento_input_2_dia = $data_nascimento_dia;
      }
      if (!isset($data_nascimento_input_2_mes) || $data_nascimento_input_2_mes == "")
      {
          $data_nascimento_input_2_mes = $data_nascimento_mes;
      }
      if (!isset($data_nascimento_input_2_ano) || $data_nascimento_input_2_ano == "")
      {
          $data_nascimento_input_2_ano = $data_nascimento_ano;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_dia'] = $data_nascimento_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_mes'] = $data_nascimento_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_ano'] = $data_nascimento_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_input_2_dia'] = $data_nascimento_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_input_2_mes'] = $data_nascimento_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_input_2_ano'] = $data_nascimento_input_2_ano; 
      if (!empty($data_nascimento_dia) || !empty($data_nascimento_mes) || !empty($data_nascimento_ano) || $data_nascimento_cond_salva == "nu" || $data_nascimento_cond_salva == "nn" || $data_nascimento_cond_salva == "ep" || $data_nascimento_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $data_nascimento_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $data_nascimento_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $data_nascimento_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $data_nascimento_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $data_nascimento_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $data_nascimento_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_cond'] = $data_nascimento_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['cmp'] = "data_nascimento"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['opc'] = $data_nascimento_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq']['data_nascimento'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['id'] = $id; 
      if (is_array($id) && !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][0] = $id;
      }
      elseif ($id_cond_salva == "nu" || $id_cond_salva == "nn" || $id_cond_salva == "ep" || $id_cond_salva == "ne" || !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][0][0] = $id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['id_cond'] = $id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['cmp'] = "id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['opc'] = $id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq']['id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['nome'] = $nome; 
      if (is_array($nome) && !empty($nome))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][0] = $nome;
      }
      elseif ($nome_cond_salva == "nu" || $nome_cond_salva == "nn" || $nome_cond_salva == "ep" || $nome_cond_salva == "ne" || !empty($nome))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][0][0] = $nome;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['nome_cond'] = $nome_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['cmp'] = "nome"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['opc'] = $nome_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq']['nome'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['cpf'] = $cpf; 
      if (is_array($cpf) && !empty($cpf))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][0] = $cpf;
      }
      elseif ($cpf_cond_salva == "nu" || $cpf_cond_salva == "nn" || $cpf_cond_salva == "ep" || $cpf_cond_salva == "ne" || !empty($cpf))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['val'][0][0] = $cpf;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['cpf_cond'] = $cpf_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['cmp'] = "cpf"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid]['opc'] = $cpf_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq']['cpf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($cpf != '') {
      ...
      if ($data_nascimento_cond != "bi_TP")
      {
          $data_nascimento_cond = strtoupper($data_nascimento_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $data_nascimento_ano;
          $Dtxt .= $data_nascimento_mes;
          $Dtxt .= $data_nascimento_dia;
          $val[0]['ano'] = $data_nascimento_ano;
          $val[0]['mes'] = $data_nascimento_mes;
          $val[0]['dia'] = $data_nascimento_dia;
          if ($data_nascimento_cond == "BW")
          {
              $val[1]['ano'] = $data_nascimento_input_2_ano;
              $val[1]['mes'] = $data_nascimento_input_2_mes;
              $val[1]['dia'] = $data_nascimento_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $data_nascimento_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $data_nascimento_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $data_nascimento = $val[0];
          $this->cmp_formatado['data_nascimento'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['data_nascimento'], "YYYY-MM-DD");
          $this->cmp_formatado['data_nascimento'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($data_nascimento_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $data_nascimento_input_2     = $val[1];
              $this->cmp_formatado['data_nascimento_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']['data_nascimento_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['data_nascimento_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['data_nascimento_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $data_nascimento_cond == "NU" || $data_nascimento_cond == "NN"|| $data_nascimento_cond == "EP"|| $data_nascimento_cond == "NE")
          {
              $this->monta_condicao("data_nascimento", $data_nascimento_cond, $data_nascimento, $data_nascimento_input_2, 'data_nascimento', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq']['data_nascimento']['label'] = $nmgp_tab_label['data_nascimento'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq']['data_nascimento']['descr'] = $nmgp_tab_label['data_nascimento'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['grid_pesq']['data_nascimento']['hint']  = $nmgp_tab_label['data_nascimento'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visita']['cond_pesq'] .= $this->NM_operador;
