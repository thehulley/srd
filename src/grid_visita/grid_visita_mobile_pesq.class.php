...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nome"  <?php echo $str_hide_nome?>><?php
      if ($nome != "")
      {
      $nome_look = substr($this->Db->qstr($nome), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tipo_id"  <?php echo $str_hide_tipo_id?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_detento_id"  <?php echo $str_hide_detento_id?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_status_id"  <?php echo $str_hide_status_id?>>
<?php
