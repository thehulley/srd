...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "data_nascimento";$Nm_datas[] = "data_nascimento";$Nm_datas[] = "data_visita";$Nm_datas[] = "data_visita";$Nm_numeric[] = "id";$Nm_numeric[] = "tipo_id";$Nm_numeric[] = "detento_id";$Nm_numeric[] = "status_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_data_nascimento_cond" name="data_nascimento_cond" onChange="nm_campos_between(document.getElementById('id_vis_data_nascimento'), this, 'data_nascimento')">
      ...
      <br><span id="id_hide_data_nascimento"  <?php echo $str_hide_data_nascimento?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_data_nascimento"  <?php echo $str_display_data_nascimento; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cpf_cond" name="cpf_cond" onChange="nm_campos_between(document.getElementById('id_vis_cpf'), this, 'cpf')">
      ...
      <br><span id="id_hide_cpf"  <?php echo $str_hide_cpf?>><?php
      if ($cpf != "")
      {
      $cpf_look = substr($this->Db->qstr($cpf), 1, -1); 
      $nmgp_def_dados = array(); 
