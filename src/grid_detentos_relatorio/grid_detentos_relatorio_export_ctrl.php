<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detentos_relatorio']['sc_process_barr'] = true;
require_once('../grid_detentos_relatorio/index.php');
unset($_SESSION['scriptcase']['grid_detentos_relatorio']['sc_process_barr']);
$ExportCtrl = new grid_detentos_relatorio_export_control;
$ExportCtrl->Export_barr();

class grid_detentos_relatorio_export_control
{
