...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["com210_____grid_detentos_relatorio"]))
   {
      unset($_SESSION['session_sec_aplicacao']["com210_____grid_detentos_relatorio"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detentos_relatorio']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detentos_relatorio']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detentos_relatorio']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detentos_relatorio']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detentos_relatorio']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detentos_relatorio</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detentos_relatorio']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detentos_relatorio']['embutida_filho'] as $ind => $sc_init)
          {
