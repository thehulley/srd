<?php
@session_start() ;
$_SESSION['scriptcase']['chart_detento']['sc_process_barr'] = true;
require_once('../chart_detento/index.php');
unset($_SESSION['scriptcase']['chart_detento']['sc_process_barr']);
$ExportCtrl = new chart_detento_export_control;
$ExportCtrl->Export_barr();

class chart_detento_export_control
{
