...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["com210_____chart_detento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["com210_____chart_detento"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_detento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_detento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_detento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_detento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_detento']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_detento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_detento']['embutida_filho'] as $ind => $sc_init)
          {
