...
$_SESSION['scriptcase']['app_menu']['contr_erro'] = 'off';
      ...
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("home") . "/?nm_run_menu=1&nm_apl_menu=app_menu&script_case_init=1";
      }
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_detento") . "/?nm_run_menu=1&nm_apl_menu=app_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_consulta") . "/?nm_run_menu=1&nm_apl_menu=app_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
