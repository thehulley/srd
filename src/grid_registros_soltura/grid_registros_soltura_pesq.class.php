...
class grid_registros_soltura_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_registros_soltura_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_registros_soltura_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_registros_soltura_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         $nome_sum = "registros_soltura.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_registros_soltura/grid_registros_soltura_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_registros_soltura_ajax_search.js"></script>
 <script type="text/javascript" src="grid_registros_soltura_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_registros_soltura_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_registros_soltura']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_registros_soltura']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_data_cond#NMF#' + search_get_sel_txt('SC_data_cond') + '@NMF@';
  str_out += 'SC_data_dia#NMF#' + search_get_sel_txt('SC_data_dia') + '@NMF@';
  str_out += 'SC_data_mes#NMF#' + search_get_sel_txt('SC_data_mes') + '@NMF@';
  str_out += 'SC_data_ano#NMF#' + search_get_sel_txt('SC_data_ano') + '@NMF@';
  str_out += 'SC_data_input_2_dia#NMF#' + search_get_sel_txt('SC_data_input_2_dia') + '@NMF@';
  str_out += 'SC_data_input_2_mes#NMF#' + search_get_sel_txt('SC_data_input_2_mes') + '@NMF@';
  str_out += 'SC_data_input_2_ano#NMF#' + search_get_sel_txt('SC_data_input_2_ano') + '@NMF@';
  str_out += 'SC_data_hor#NMF#' + search_get_sel_txt('SC_data_hor') + '@NMF@';
  str_out += 'SC_data_min#NMF#' + search_get_sel_txt('SC_data_min') + '@NMF@';
  str_out += 'SC_data_seg#NMF#' + search_get_sel_txt('SC_data_seg') + '@NMF@';
  str_out += 'SC_data_input_2_hor#NMF#' + search_get_sel_txt('SC_data_input_2_hor') + '@NMF@';
  str_out += 'SC_data_input_2_min#NMF#' + search_get_sel_txt('SC_data_input_2_min') + '@NMF@';
  str_out += 'SC_data_input_2_seg#NMF#' + search_get_sel_txt('SC_data_input_2_seg') + '@NMF@';
  ...
  str_out += 'id_ac_motivo#NMF#' + search_get_text('id_ac_motivo') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_motivo").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_motivo").autocomplete({
     minLength: 1,
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Registros Soltura</div>
...
<?php
   ...
   {
      global 
             $data_cond, $data, $data_dia, $data_mes, $data_ano, $data_hor, $data_min, $data_seg, $data_input_2_dia, $data_input_2_mes, $data_input_2_ano, $data_input_2_min, $data_input_2_hor, $data_input_2_seg,
             $id_cond, $id,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $data_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_dia']; 
          $data_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_mes']; 
          $data_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_ano']; 
          $data_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_dia']; 
          $data_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_mes']; 
          $data_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_ano']; 
          $data_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_hor']; 
          $data_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_min']; 
          $data_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_seg']; 
          $data_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_hor']; 
          $data_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_min']; 
          $data_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_seg']; 
          $data_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['id_cond']; 
          $detento_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['detento_id']; 
          $detento_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['detento_id_cond']; 
          $motivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['motivo']; 
          $motivo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['motivo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['NM_operador']; 
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_data_cond" name="data_cond" onChange="nm_campos_between(document.getElementById('id_vis_data'), this, 'data')">
       <OPTION value="eq" <?php if ("eq" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_dia" name="data_dia" value="<?php echo NM_encode_input($data_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_mes" name="data_mes" value="<?php echo NM_encode_input($data_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_ano" name="data_ano" value="<?php echo NM_encode_input($data_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_hor" name="data_hor" value="<?php echo NM_encode_input($data_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_min" name="data_min" value="<?php echo NM_encode_input($data_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_seg" name="data_seg" value="<?php echo NM_encode_input($data_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_data"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_data"  <?php echo $str_display_data; ?> class="scFilterFieldFontOdd">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_input_2_dia" name="data_input_2_dia" value="<?php echo NM_encode_input($data_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_input_2_mes" name="data_input_2_mes" value="<?php echo NM_encode_input($data_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_input_2_ano" name="data_input_2_ano" value="<?php echo NM_encode_input($data_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_input_2_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_input_2_hor" name="data_input_2_hor" value="<?php echo NM_encode_input($data_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_input_2_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_input_2_min" name="data_input_2_min" value="<?php echo NM_encode_input($data_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_input_2_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_data_input_2_seg" name="data_input_2_seg" value="<?php echo NM_encode_input($data_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT  type="text" id="SC_detento_id" name="detento_id" value="<?php echo NM_encode_input($detento_id) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_motivo_cond" name="motivo_cond" onChange="nm_campos_between(document.getElementById('id_vis_motivo'), this, 'motivo')">
...
?>
<INPUT  type="text" id="SC_motivo" name="motivo" value="<?php echo NM_encode_input($motivo) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_motivo" name="motivo_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_registros_soltura_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_registros_soltura']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_registros_soltura']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.data_cond.value = 'eq';
   ...
   document.F1.data_hor.value = "";
   document.F1.data_min.value = "";
   document.F1.data_seg.value = "";
   document.F1.data_input_2_hor.value = "";
   document.F1.data_input_2_min.value = "";
   document.F1.data_input_2_seg.value = "";
 ...
 {
    $('#SC_data_dia').bind('change', function() {sc_grid_registros_soltura_valida_dia(this)});
    $('#SC_data_hor').bind('change', function() {sc_grid_registros_soltura_valida_hora(this)});
    $('#SC_data_input_2_dia').bind('change', function() {sc_grid_registros_soltura_valida_dia(this)});
    $('#SC_data_input_2_hor').bind('change', function() {sc_grid_registros_soltura_valida_hora(this)});
    $('#SC_data_input_2_mes').bind('change', function() {sc_grid_registros_soltura_valida_mes(this)});
    $('#SC_data_input_2_min').bind('change', function() {sc_grid_registros_soltura_valida_min(this)});
    $('#SC_data_input_2_seg').bind('change', function() {sc_grid_registros_soltura_valida_seg(this)});
    $('#SC_data_mes').bind('change', function() {sc_grid_registros_soltura_valida_mes(this)});
    $('#SC_data_min').bind('change', function() {sc_grid_registros_soltura_valida_min(this)});
    $('#SC_data_seg').bind('change', function() {sc_grid_registros_soltura_valida_seg(this)});
 }
 function sc_grid_registros_soltura_valida_dia(obj)
 {
 ...
 function sc_grid_registros_soltura_valida_mes(obj)
 {
 ...
 function sc_grid_registros_soltura_valida_hora(obj)
 {
 ...
 function sc_grid_registros_soltura_valida_min(obj)
 {
 ...
 function sc_grid_registros_soltura_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_registros_soltura/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_data_cond'] = 'cond';
      $tp_fields['SC_data_dia'] = 'text';
      $tp_fields['SC_data_mes'] = 'text';
      $tp_fields['SC_data_ano'] = 'text';
      $tp_fields['SC_data_input_2_dia'] = 'text';
      $tp_fields['SC_data_input_2_mes'] = 'text';
      $tp_fields['SC_data_input_2_ano'] = 'text';
      $tp_fields['SC_data_hor'] = 'text';
      $tp_fields['SC_data_min'] = 'text';
      $tp_fields['SC_data_seg'] = 'text';
      $tp_fields['SC_data_input_2_hor'] = 'text';
      $tp_fields['SC_data_input_2_min'] = 'text';
      $tp_fields['SC_data_input_2_seg'] = 'text';
      ...
      $tp_fields['id_ac_motivo'] = 'text_aut';
   ...
   {
      global $data_cond, $data, $data_dia, $data_mes, $data_ano, $data_hor, $data_min, $data_seg, $data_input_2_dia, $data_input_2_mes, $data_input_2_ano, $data_input_2_min, $data_input_2_hor, $data_input_2_seg,
             $id_cond, $id,
             $detento_id_cond, $detento_id,
             $motivo_cond, $motivo, $motivo_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq'] = array();
      ...
      if (!isset($data_input_2_hor) || $data_input_2_hor == "")
      {
          $data_input_2_hor = $data_hor;
      }
      if (!isset($data_input_2_min) || $data_input_2_min == "")
      {
          $data_input_2_min = $data_min;
      }
      if (!isset($data_input_2_seg) || $data_input_2_seg == "")
      {
          $data_input_2_seg = $data_seg;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_dia'] = $data_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_mes'] = $data_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_ano'] = $data_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_dia'] = $data_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_mes'] = $data_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_ano'] = $data_input_2_ano; 
      if (!empty($data_dia) || !empty($data_mes) || !empty($data_ano) || $data_cond_salva == "nu" || $data_cond_salva == "nn" || $data_cond_salva == "ep" || $data_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $data_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $data_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $data_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $data_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $data_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $data_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_hor'] = $data_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_min'] = $data_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_seg'] = $data_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_hor'] = $data_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_min'] = $data_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2_seg'] = $data_input_2_seg; 
      if (!empty($data_hor) || !empty($data_min) || !empty($data_seg) || $data_cond_salva == "nu" || $data_cond_salva == "nn" || $data_cond_salva == "ep" || $data_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $data_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $data_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $data_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $data_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $data_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $data_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_cond'] = $data_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['cmp'] = "data"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['opc'] = $data_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq']['data'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['id'] = $id; 
      if (is_array($id) && !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0] = $id;
      }
      elseif ($id_cond_salva == "nu" || $id_cond_salva == "nn" || $id_cond_salva == "ep" || $id_cond_salva == "ne" || !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0][0] = $id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['id_cond'] = $id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['cmp'] = "id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['opc'] = $id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq']['id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['detento_id'] = $detento_id; 
      if (is_array($detento_id) && !empty($detento_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0] = $detento_id;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0][0] = $detento_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['detento_id_cond'] = $detento_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['cmp'] = "detento_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['opc'] = $detento_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq']['detento_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['motivo'] = $motivo; 
      if (is_array($motivo) && !empty($motivo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0] = $motivo;
      }
      elseif ($motivo_cond_salva == "nu" || $motivo_cond_salva == "nn" || $motivo_cond_salva == "ep" || $motivo_cond_salva == "ne" || !empty($motivo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['val'][0][0] = $motivo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['motivo_cond'] = $motivo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['cmp'] = "motivo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid]['opc'] = $motivo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq']['motivo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($motivo != '') {
      ...
      if ($data_cond != "bi_TP")
      {
          ...
          if ($data_cond == "BW")
          {
              ...
              $val[1]['hor'] = $data_input_2_hor;
              $val[1]['min'] = $data_input_2_min;
              $val[1]['seg'] = $data_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "DATETIME", $data_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $data = $val[0];
          $this->cmp_formatado['data'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['data'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['data'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($data_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']['data_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['data_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['data_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $data_cond == "NU" || $data_cond == "NN"|| $data_cond == "EP"|| $data_cond == "NE")
          {
              $this->monta_condicao("data", $data_cond, $data, $data_input_2, 'data', 'DATETIME');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq']['data']['label'] = $nmgp_tab_label['data'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq']['data']['descr'] = $nmgp_tab_label['data'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['grid_pesq']['data']['hint']  = $nmgp_tab_label['data'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registros_soltura']['cond_pesq'] .= $this->NM_operador;
