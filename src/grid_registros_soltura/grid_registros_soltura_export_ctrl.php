<?php
@session_start() ;
$_SESSION['scriptcase']['grid_registros_soltura']['sc_process_barr'] = true;
require_once('../grid_registros_soltura/index.php');
unset($_SESSION['scriptcase']['grid_registros_soltura']['sc_process_barr']);
$ExportCtrl = new grid_registros_soltura_export_control;
$ExportCtrl->Export_barr();

class grid_registros_soltura_export_control
{
