...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "data";$Nm_datas[] = "data";$Nm_numeric[] = "id";$Nm_numeric[] = "detento_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_data_cond" name="data_cond" onChange="nm_campos_between(document.getElementById('id_vis_data'), this, 'data')">
      ...
      <br><span id="id_hide_data"  <?php echo $str_hide_data?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_motivo_cond" name="motivo_cond" onChange="nm_campos_between(document.getElementById('id_vis_motivo'), this, 'motivo')">
      ...
      <br><span id="id_hide_motivo"  <?php echo $str_hide_motivo?>><?php
      if ($motivo != "")
      {
      $motivo_look = substr($this->Db->qstr($motivo), 1, -1); 
      $nmgp_def_dados = array(); 
