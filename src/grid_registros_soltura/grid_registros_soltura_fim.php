...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["com210_____grid_registros_soltura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["com210_____grid_registros_soltura"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_registros_soltura'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_registros_soltura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_registros_soltura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_registros_soltura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_registros_soltura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_registros_soltura']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_registros_soltura</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_registros_soltura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_registros_soltura']['embutida_filho'] as $ind => $sc_init)
          {
