...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate matricula
  function do_ajax_app_form_edit_users_mob_validate_matricula()
  {
    var nomeCampo_matricula = "matricula";
    var var_matricula = scAjaxGetFieldText(nomeCampo_matricula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_mob_validate_matricula(var_matricula, var_script_case_init, do_ajax_app_form_edit_users_mob_validate_matricula_cb);
  } // do_ajax_app_form_edit_users_mob_validate_matricula

  function do_ajax_app_form_edit_users_mob_validate_matricula_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_mob_validate_matricula_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_edit_users_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_mob_submit_form(var_matricula, var_senha, var_confirm_pswd, var_nome, var_email, var_ativo, var_groups, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_mob_submit_form_cb);
...
?>
  ...
  function perform_ajax_app_form_edit_users_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_mob_navigate_form(var_matricula, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_edit_users_mob_navigate_form_cb);
