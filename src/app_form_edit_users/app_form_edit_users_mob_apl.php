...
//---------------------------------------------------------
    ...
    function ValidateField_matricula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['matricula'] == "on")) 
      { 
          if ($this->matricula == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_senha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (($this->nmgp_opcao == "incluir" || 'validate_senha' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['php_cmp_required']['senha'] == "on"))
      { 
          if ($this->senha == "")  
          { 
              $hasError = true;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['matricula']['keyVal'] = app_form_edit_users_mob_pack_protect_string($this->nmgp_dados_form['matricula']);
          }
   } // ajax_return_values
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_ativo'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['ativo']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
...
$_SESSION['scriptcase']['app_form_edit_users_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['parms'] = "matricula?#?$this->matricula?@?"; 
      }
      $this->NM_commit_db(); 
