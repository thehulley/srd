...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_matricula' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_matricula_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_app_form_edit_users_matricula_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_app_form_edit_users_matricula_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_privilegio_admin' + iSeqRow).bind('change', function() { sc_app_form_edit_users_privilegio_admin_onchange(this, iSeqRow) });
  ...
  $('.sc-ui-checkbox-ativo' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd

function sc_app_form_edit_users_matricula_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_matricula();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_matricula_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_matricula_onfocus(oThis, iSeqRow) {
...
function sc_app_form_edit_users_privilegio_admin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
