...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["com210_____grid_funcionario_relatorio"]))
   {
      unset($_SESSION['session_sec_aplicacao']["com210_____grid_funcionario_relatorio"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_funcionario_relatorio']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_funcionario_relatorio']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_funcionario_relatorio']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_funcionario_relatorio']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario_relatorio']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_funcionario_relatorio</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_funcionario_relatorio']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_funcionario_relatorio']['embutida_filho'] as $ind => $sc_init)
          {
