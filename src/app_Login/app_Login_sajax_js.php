...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_Login_submit_form()
  {
    ...
    x_ajax_app_Login_submit_form(var_login, var_pswd, var_links, var_remember_me, var_links_sc_target_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_app_Login_submit_form_cb);
