...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_funcionario_relatorio/form_funcionario_relatorio_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_funcionario_relatorio_sajax_js.php");
?>
<script type="text/javascript">
...
function navpage_atualiza(str_navpage)
{
 ...
 function nm_field_disabled(Fields, Opt) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "telefone")
     {
        $('input[name="telefone"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="telefone"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="telefone"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "email")
     {
        $('input[name="email"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="email"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="email"]').removeClass("scFormInputDisabled");
        }
        $('input[id="email_mail"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('#email_mail').hide();
        }
        else {
     ...
     if (F_name == "funcao_id")
     {
        $('select[name="funcao_id"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('select[name="funcao_id"]').addClass("scFormInputDisabled");
        }
        else {
            $('select[name="funcao_id"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "setor")
     {
        $('input[name="setor"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="setor"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="setor"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "ativo")
     {
        $('input[name="ativo"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="ativo"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="ativo"]').removeClass("scFormInputDisabled");
        }
     }
  }
 } // nm_field_disabled
...
include_once('form_funcionario_relatorio_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_funcionario_relatorio_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_funcionario_relatorio'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_funcionario_relatorio'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nome_label" id="hidden_field_label_nome" style="<?php echo $sStyleHidden_nome; ?>"><span id="id_label_nome"><?php echo $this->nm_new_label['nome']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['nome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['nome'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_matricula_label" id="hidden_field_label_matricula" style="<?php echo $sStyleHidden_matricula; ?>"><span id="id_label_matricula"><?php echo $this->nm_new_label['matricula']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['matricula'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_telefone_label" id="hidden_field_label_telefone" style="<?php echo $sStyleHidden_telefone; ?>"><span id="id_label_telefone"><?php echo $this->nm_new_label['telefone']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['telefone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['telefone'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_telefone_line" id="hidden_field_data_telefone" style="<?php echo $sStyleHidden_telefone; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telefone_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_email_label" id="hidden_field_label_email" style="<?php echo $sStyleHidden_email; ?>"><span id="id_label_email"><?php echo $this->nm_new_label['email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_nascimento_label" id="hidden_field_label_data_nascimento" style="<?php echo $sStyleHidden_data_nascimento; ?>"><span id="id_label_data_nascimento"><?php echo $this->nm_new_label['data_nascimento']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['data_nascimento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['data_nascimento'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_funcao_id_label" id="hidden_field_label_funcao_id" style="<?php echo $sStyleHidden_funcao_id; ?>"><span id="id_label_funcao_id"><?php echo $this->nm_new_label['funcao_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['funcao_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['funcao_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_funcao_id_line" id="hidden_field_data_funcao_id" style="<?php echo $sStyleHidden_funcao_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_funcao_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ativo_label" id="hidden_field_label_ativo" style="<?php echo $sStyleHidden_ativo; ?>"><span id="id_label_ativo"><?php echo $this->nm_new_label['ativo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['ativo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['php_cmp_required']['ativo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['Lookup_ativo'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['Lookup_ativo'][] = 'N'; ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_funcionario_relatorio");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_funcionario_relatorio");
 parent.scAjaxDetailHeight("form_funcionario_relatorio", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
