  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_funcionario_relatorio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_funcionario_relatorio_form();
	}
  ...
  // ---------- Validate nome
  function do_ajax_form_funcionario_relatorio_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_relatorio_validate_nome(var_nome, var_script_case_init, do_ajax_form_funcionario_relatorio_validate_nome_cb);
  } // do_ajax_form_funcionario_relatorio_validate_nome

  function do_ajax_form_funcionario_relatorio_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_relatorio_validate_nome_cb

  // ---------- Validate matricula
  function do_ajax_form_funcionario_relatorio_validate_matricula()
  {
    var nomeCampo_matricula = "matricula";
    var var_matricula = scAjaxGetFieldText(nomeCampo_matricula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_relatorio_validate_matricula(var_matricula, var_script_case_init, do_ajax_form_funcionario_relatorio_validate_matricula_cb);
  } // do_ajax_form_funcionario_relatorio_validate_matricula

  function do_ajax_form_funcionario_relatorio_validate_matricula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_relatorio_validate_matricula_cb

  // ---------- Validate telefone
  function do_ajax_form_funcionario_relatorio_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_relatorio_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_funcionario_relatorio_validate_telefone_cb);
  } // do_ajax_form_funcionario_relatorio_validate_telefone

  function do_ajax_form_funcionario_relatorio_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_relatorio_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_funcionario_relatorio_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_relatorio_validate_email(var_email, var_script_case_init, do_ajax_form_funcionario_relatorio_validate_email_cb);
  } // do_ajax_form_funcionario_relatorio_validate_email

  function do_ajax_form_funcionario_relatorio_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_relatorio_validate_email_cb

  // ---------- Validate data_nascimento
  function do_ajax_form_funcionario_relatorio_validate_data_nascimento()
  {
    ...
    setTimeout(function() {
      var var_data_nascimento = scAjaxGetFieldText(nomeCampo_data_nascimento);
      x_ajax_form_funcionario_relatorio_validate_data_nascimento(var_data_nascimento, var_script_case_init, do_ajax_form_funcionario_relatorio_validate_data_nascimento_cb);
    }, 200);
  } // do_ajax_form_funcionario_relatorio_validate_data_nascimento

  function do_ajax_form_funcionario_relatorio_validate_data_nascimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_relatorio_validate_data_nascimento_cb

  // ---------- Validate funcao_id
  function do_ajax_form_funcionario_relatorio_validate_funcao_id()
  {
    var nomeCampo_funcao_id = "funcao_id";
    var var_funcao_id = scAjaxGetFieldSelect(nomeCampo_funcao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_relatorio_validate_funcao_id(var_funcao_id, var_script_case_init, do_ajax_form_funcionario_relatorio_validate_funcao_id_cb);
  } // do_ajax_form_funcionario_relatorio_validate_funcao_id

  function do_ajax_form_funcionario_relatorio_validate_funcao_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_relatorio_validate_funcao_id_cb

  // ---------- Validate setor
  function do_ajax_form_funcionario_relatorio_validate_setor()
  {
    var nomeCampo_setor = "setor";
    var var_setor = scAjaxGetFieldText(nomeCampo_setor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_relatorio_validate_setor(var_setor, var_script_case_init, do_ajax_form_funcionario_relatorio_validate_setor_cb);
  } // do_ajax_form_funcionario_relatorio_validate_setor

  function do_ajax_form_funcionario_relatorio_validate_setor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "setor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_relatorio_validate_setor_cb

  // ---------- Validate ativo
  function do_ajax_form_funcionario_relatorio_validate_ativo()
  {
    var nomeCampo_ativo = "ativo";
    var var_ativo = scAjaxGetFieldRadio(nomeCampo_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_relatorio_validate_ativo(var_ativo, var_script_case_init, do_ajax_form_funcionario_relatorio_validate_ativo_cb);
  } // do_ajax_form_funcionario_relatorio_validate_ativo

  function do_ajax_form_funcionario_relatorio_validate_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ativo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_relatorio_validate_ativo_cb

  // ---------- Event onchange cpf
  function do_ajax_form_funcionario_relatorio_event_cpf_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_funcionario_relatorio_event_cpf_onchange(var_script_case_init, do_ajax_form_funcionario_relatorio_event_cpf_onchange_cb);
  } // do_ajax_form_funcionario_relatorio_event_cpf_onchange

  function do_ajax_form_funcionario_relatorio_event_cpf_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_funcionario_relatorio_event_cpf_onchange_cb_after_alert);
  } // do_ajax_form_funcionario_relatorio_event_cpf_onchange_cb
  function do_ajax_form_funcionario_relatorio_event_cpf_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_funcionario_relatorio_event_cpf_onchange_cb_after_alert

  // ---------- Event onchange matricula
  function do_ajax_form_funcionario_relatorio_event_matricula_onchange()
  {
    var var_matricula = scAjaxGetFieldText("matricula");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_funcionario_relatorio_event_matricula_onchange(var_matricula, var_script_case_init, do_ajax_form_funcionario_relatorio_event_matricula_onchange_cb);
  } // do_ajax_form_funcionario_relatorio_event_matricula_onchange

  function do_ajax_form_funcionario_relatorio_event_matricula_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "matricula";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_funcionario_relatorio_event_matricula_onchange_cb_after_alert);
  } // do_ajax_form_funcionario_relatorio_event_matricula_onchange_cb
  function do_ajax_form_funcionario_relatorio_event_matricula_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_funcionario_relatorio_event_matricula_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_funcionario_relatorio_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_funcionario_relatorio_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_funcionario_relatorio_submit_form(var_nome, var_matricula, var_telefone, var_email, var_data_nascimento, var_funcao_id, var_setor, var_ativo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_funcionario_relatorio_submit_form_cb);
  } // do_ajax_form_funcionario_relatorio_submit_form

  function do_ajax_form_funcionario_relatorio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_funcionario_relatorio_submit_form_cb_after_alert);
  } // do_ajax_form_funcionario_relatorio_submit_form_cb
  function do_ajax_form_funcionario_relatorio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_funcionario_relatorio_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_funcionario_relatorio_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_funcionario_relatorio_navigate_form, function() {});
    } else {
      perform_ajax_form_funcionario_relatorio_navigate_form();
    }
  }

  function perform_ajax_form_funcionario_relatorio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_funcionario_relatorio_navigate_form(var_matricula, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionario_relatorio_navigate_form_cb);
  } // do_ajax_form_funcionario_relatorio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_relatorio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_funcionario_relatorio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_funcionario_relatorio_navigate_form_cb_after_alert);
  } // do_ajax_form_funcionario_relatorio_navigate_form_cb
  function do_ajax_form_funcionario_relatorio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_funcionario_relatorio_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_funcionario_relatorio_navigate_form_cb_after_alert
  function sc_hide_form_funcionario_relatorio_form()
  {
