...
<?php
   ...
   $Ord_Cmp = new grid_detento_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detento_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["nome"] : "Nome";
   $tab_ger_campos['cpf'] = "on";
   $tab_def_campos['cpf'] = "cpf";
   $tab_labels["cpf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["cpf"])) ? $_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["cpf"] : "CPF";
   $tab_ger_campos['matricula'] = "on";
   $tab_def_campos['matricula'] = "matricula";
   $tab_labels["matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["matricula"])) ? $_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["matricula"] : "Matrícula";
   $tab_ger_campos['data_nascimento'] = "on";
   $tab_def_campos['data_nascimento'] = "data_nascimento";
   $tab_labels["data_nascimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["data_nascimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["data_nascimento"] : "Data de Nascimento";
   $tab_ger_campos['data_inicio_pena'] = "on";
   $tab_def_campos['data_inicio_pena'] = "data_inicio_pena";
   $tab_labels["data_inicio_pena"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["data_inicio_pena"])) ? $_SESSION['sc_session'][$sc_init]['grid_detento']['labels']["data_inicio_pena"] : "Início da Pena";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detento']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detento']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detento']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detento_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detento']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
