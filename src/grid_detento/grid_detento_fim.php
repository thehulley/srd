...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["com210_____grid_detento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["com210_____grid_detento"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_detento'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detento']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detento']['embutida_filho'] as $ind => $sc_init)
          {
