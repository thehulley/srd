<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detento']['sc_process_barr'] = true;
require_once('../grid_detento/index.php');
unset($_SESSION['scriptcase']['grid_detento']['sc_process_barr']);
$ExportCtrl = new grid_detento_export_control;
$ExportCtrl->Export_barr();

class grid_detento_export_control
{
