<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['home']['glo_nm_perfil']          = "conn_mysql";
...
// 
    ...
    $out1_img_cache = $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['home']['glo_nm_conexao'], $this->root . $this->path_prod, 'com210', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['home']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['home']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['home']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['home']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
...
//
 ...
 echo '<div style="margin: 250px auto 0; color: 35404F; text-align: center; font-family: \'Roboto\', sans-serif;">
    <h1 style="font-weight: bold; font-size: 3rem;">Seja Bem-Vindo(a)</h1>
    <p style="font-size: 1.5rem;">Utilize o menu superior para navegar entre as opções disponíveis!</p>
</div>';
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'] . "/sc_apl_default_com210.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'] . "/sc_apl_default_com210.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "home") {
           ...
           if (isset($_COOKIE['sc_actual_lang_com210'])) {
               $_SESSION['scriptcase']['home']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_com210'];
           }
       }
   }
