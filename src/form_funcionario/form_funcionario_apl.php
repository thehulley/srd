   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " funcionario";
      ...
      {
          $this->nmgp_botoes['excluir_funcionario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['botoes']['excluir_funcionario'];
      }
...
//
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_select']['senha']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->senha = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_select']['senha'];
          } 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_form']['id']))
          {
              $varloc_btn_php['id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_form']['id'];
          }
      }
      $nm_f_saida = "./";
...
//---
    ...
    function ValidateField_nome(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['nome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['nome'] == "on")) 
      { 
          if ($this->nome == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_cpf(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['cpf']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['cpf'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "CPF" ;
              if (!isset($Campos_Erros['cpf']))
    ...
    function ValidateField_matricula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['matricula'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_telefone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      $this->nm_tira_mask($this->telefone, "(99) 9 9999-9999", "(){}[].,;:-+/ "); 
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['telefone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['telefone'] == "on")) 
      { 
          if ($this->telefone == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['email'] == "on") 
          { 
              $hasError = true;
              $Campos_Falta[] = "E-mail" ; 
              if (!isset($Campos_Erros['email']))
    ...
    function ValidateField_data_nascimento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['data_nascimento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['data_nascimento'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_funcao_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->funcao_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['funcao_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['funcao_id'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Função" ; 
          ...
          if (!empty($this->funcao_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_funcao_id']) && !in_array($this->funcao_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_funcao_id']))
          {
              $hasError = true;
    ...
    function ValidateField_senha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['senha'] == "on")) 
      { 
          if ($this->senha == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_ativo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['ativo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['ativo'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Ativo" ; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_funcao_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_funcao_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_funcao_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_funcao_id'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_funcao_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['funcao_id']['valList'][$i] = form_funcionario_pack_protect_string($v);
          }
...
$aLookup[] = array(form_funcionario_pack_protect_string('Y') => str_replace('<', '&lt;',form_funcionario_pack_protect_string("Sim")));
$aLookup[] = array(form_funcionario_pack_protect_string('N') => str_replace('<', '&lt;',form_funcionario_pack_protect_string("Não")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_ativo'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_ativo'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = $qt_geral_reg_form_funcionario; 
          }
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] + 1;
...
//---------- 
      ...
      { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] . ")" ; 
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              ...
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] < $qt_geral_reg_form_funcionario;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] + 1;
