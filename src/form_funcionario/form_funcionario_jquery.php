...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_form_funcionario_id_onchange(this, iSeqRow) });
  $('#id_sc_field_nome' + iSeqRow).bind('blur', function() { sc_form_funcionario_nome_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_funcionario_nome_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_funcionario_nome_onfocus(this, iSeqRow) });
  $('#id_sc_field_cpf' + iSeqRow).bind('blur', function() { sc_form_funcionario_cpf_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_funcionario_cpf_onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_funcionario_cpf_onfocus(this, iSeqRow) });
  $('#id_sc_field_matricula' + iSeqRow).bind('blur', function() { sc_form_funcionario_matricula_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_funcionario_matricula_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_funcionario_matricula_onfocus(this, iSeqRow) });
  $('#id_sc_field_telefone' + iSeqRow).bind('blur', function() { sc_form_funcionario_telefone_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_funcionario_telefone_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_funcionario_telefone_onfocus(this, iSeqRow) });
  $('#id_sc_field_data_nascimento' + iSeqRow).bind('blur', function() { sc_form_funcionario_data_nascimento_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_funcionario_data_nascimento_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_funcionario_data_nascimento_onfocus(this, iSeqRow) });
  $('#id_sc_field_funcao_id' + iSeqRow).bind('blur', function() { sc_form_funcionario_funcao_id_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_funcionario_funcao_id_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_funcionario_funcao_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_senha' + iSeqRow).bind('blur', function() { sc_form_funcionario_senha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_funcionario_senha_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_funcionario_senha_onfocus(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_form_funcionario_email_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_funcionario_email_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_funcionario_email_onfocus(this, iSeqRow) });
  $('#id_sc_field_ativo' + iSeqRow).bind('blur', function() { sc_form_funcionario_ativo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_funcionario_ativo_onchange(this, iSeqRow) })
...
function sc_form_funcionario_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_funcionario_nome_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionario_validate_nome();
  scCssBlur(oThis);
}

function sc_form_funcionario_nome_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_funcionario_nome_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionario_cpf_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionario_validate_cpf();
  scCssBlur(oThis);
}

function sc_form_funcionario_cpf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_funcionario_event_cpf_onchange();
}

function sc_form_funcionario_cpf_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionario_matricula_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionario_validate_matricula();
  scCssBlur(oThis);
}

function sc_form_funcionario_matricula_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_funcionario_event_matricula_onchange();
}

function sc_form_funcionario_matricula_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionario_telefone_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionario_validate_telefone();
  scCssBlur(oThis);
}

function sc_form_funcionario_telefone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_funcionario_telefone_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionario_data_nascimento_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionario_validate_data_nascimento();
  scCssBlur(oThis);
}

function sc_form_funcionario_data_nascimento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_funcionario_data_nascimento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionario_funcao_id_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionario_validate_funcao_id();
  scCssBlur(oThis);
}

function sc_form_funcionario_funcao_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_funcionario_funcao_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionario_senha_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionario_validate_senha();
  scCssBlur(oThis);
}

function sc_form_funcionario_senha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_funcionario_senha_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionario_email_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionario_validate_email();
  scCssBlur(oThis);
}

function sc_form_funcionario_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_funcionario_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionario_ativo_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionario_validate_ativo();
  scCssBlur(oThis);
}

function sc_form_funcionario_ativo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_funcionario_ativo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionario_codigo_ativacao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_funcionario_privilegio_admin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_data_nascimento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_funcionario_validate_data_nascimento(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
