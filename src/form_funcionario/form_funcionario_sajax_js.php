...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nome
  function do_ajax_form_funcionario_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_nome(var_nome, var_script_case_init, do_ajax_form_funcionario_validate_nome_cb);
  } // do_ajax_form_funcionario_validate_nome

  function do_ajax_form_funcionario_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_nome_cb

  // ---------- Validate cpf
  function do_ajax_form_funcionario_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldText(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_cpf(var_cpf, var_script_case_init, do_ajax_form_funcionario_validate_cpf_cb);
  } // do_ajax_form_funcionario_validate_cpf

  function do_ajax_form_funcionario_validate_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cpf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_cpf_cb

  // ---------- Validate matricula
  function do_ajax_form_funcionario_validate_matricula()
  {
    var nomeCampo_matricula = "matricula";
    var var_matricula = scAjaxGetFieldText(nomeCampo_matricula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_matricula(var_matricula, var_script_case_init, do_ajax_form_funcionario_validate_matricula_cb);
  } // do_ajax_form_funcionario_validate_matricula

  function do_ajax_form_funcionario_validate_matricula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_matricula_cb

  // ---------- Validate telefone
  function do_ajax_form_funcionario_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_funcionario_validate_telefone_cb);
  } // do_ajax_form_funcionario_validate_telefone

  function do_ajax_form_funcionario_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_funcionario_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_email(var_email, var_script_case_init, do_ajax_form_funcionario_validate_email_cb);
  } // do_ajax_form_funcionario_validate_email

  function do_ajax_form_funcionario_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_email_cb

  // ---------- Validate data_nascimento
  function do_ajax_form_funcionario_validate_data_nascimento()
  {
  ...
  function do_ajax_form_funcionario_validate_data_nascimento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_data_nascimento_cb

  // ---------- Validate funcao_id
  function do_ajax_form_funcionario_validate_funcao_id()
  {
    var nomeCampo_funcao_id = "funcao_id";
    var var_funcao_id = scAjaxGetFieldSelect(nomeCampo_funcao_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_funcao_id(var_funcao_id, var_script_case_init, do_ajax_form_funcionario_validate_funcao_id_cb);
  } // do_ajax_form_funcionario_validate_funcao_id

  function do_ajax_form_funcionario_validate_funcao_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_funcao_id_cb

  // ---------- Validate senha
  function do_ajax_form_funcionario_validate_senha()
  {
    var nomeCampo_senha = "senha";
    var var_senha = scAjaxGetFieldText(nomeCampo_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_senha(var_senha, var_script_case_init, do_ajax_form_funcionario_validate_senha_cb);
  } // do_ajax_form_funcionario_validate_senha

  function do_ajax_form_funcionario_validate_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "senha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_senha_cb

  // ---------- Validate ativo
  function do_ajax_form_funcionario_validate_ativo()
  {
    var nomeCampo_ativo = "ativo";
    var var_ativo = scAjaxGetFieldRadio(nomeCampo_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_ativo(var_ativo, var_script_case_init, do_ajax_form_funcionario_validate_ativo_cb);
  } // do_ajax_form_funcionario_validate_ativo

  function do_ajax_form_funcionario_validate_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ativo";
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_funcionario_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_funcionario_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_funcionario_navigate_form, function() {});
    } else {
      perform_ajax_form_funcionario_navigate_form();
    }
  }

  function perform_ajax_form_funcionario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_funcionario_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionario_navigate_form_cb);
