...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_funcionario_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_excluir_funcionario()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_excluir_funcionario(); }, 500);
      return;
    }
...
function sc_btn_excluir_funcionario_ok()
{
    Crtl_btn_excluir_funcionario = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?excluir_funcionario?@?";
    document.F1.action = "form_funcionario_mob.php";
...
{
   nm_field_disabled("senha=disabled", "U");
