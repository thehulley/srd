...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_funcionario_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_funcionario_mob_submit_form(var_nome, var_cpf, var_matricula, var_telefone, var_email, var_data_nascimento, var_funcao_id, var_senha, var_ativo, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_funcionario_mob_submit_form_cb);
