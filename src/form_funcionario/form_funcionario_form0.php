...
else
{
    ...
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['insert_validation']; ?>">
<?php
}
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && ($opcao_botoes != "novo")) {
        $sCondStyle = ($this->nmgp_botoes['excluir_funcionario'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "excluir_funcionario", "scBtnFn_excluir_funcionario()", "scBtnFn_excluir_funcionario()", "sc_excluir_funcionario_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nome_label" id="hidden_field_label_nome" style="<?php echo $sStyleHidden_nome; ?>"><span id="id_label_nome"><?php echo $this->nm_new_label['nome']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['nome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['nome'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cpf_label" id="hidden_field_label_cpf" style="<?php echo $sStyleHidden_cpf; ?>"><span id="id_label_cpf"><?php echo $this->nm_new_label['cpf']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['cpf']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['cpf'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_matricula_label" id="hidden_field_label_matricula" style="<?php echo $sStyleHidden_matricula; ?>"><span id="id_label_matricula"><?php echo $this->nm_new_label['matricula']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['matricula'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_telefone_label" id="hidden_field_label_telefone" style="<?php echo $sStyleHidden_telefone; ?>"><span id="id_label_telefone"><?php echo $this->nm_new_label['telefone']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['telefone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['telefone'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_email_label" id="hidden_field_label_email" style="<?php echo $sStyleHidden_email; ?>"><span id="id_label_email"><?php echo $this->nm_new_label['email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_nascimento_label" id="hidden_field_label_data_nascimento" style="<?php echo $sStyleHidden_data_nascimento; ?>"><span id="id_label_data_nascimento"><?php echo $this->nm_new_label['data_nascimento']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['data_nascimento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['data_nascimento'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_funcao_id_label" id="hidden_field_label_funcao_id" style="<?php echo $sStyleHidden_funcao_id; ?>"><span id="id_label_funcao_id"><?php echo $this->nm_new_label['funcao_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['funcao_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['funcao_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_senha_label" id="hidden_field_label_senha" style="<?php echo $sStyleHidden_senha; ?>"><span id="id_label_senha"><?php echo $this->nm_new_label['senha']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['senha'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ativo_label" id="hidden_field_label_ativo" style="<?php echo $sStyleHidden_ativo; ?>"><span id="id_label_ativo"><?php echo $this->nm_new_label['ativo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['ativo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['php_cmp_required']['ativo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_ativo'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_ativo'][] = 'N'; ?>
