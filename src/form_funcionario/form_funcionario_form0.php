...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_telefone_label" id="hidden_field_label_telefone" style="<?php echo $sStyleHidden_telefone; ?>"><span id="id_label_telefone"><?php echo $this->nm_new_label['telefone']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_funcao_id_label" id="hidden_field_label_funcao_id" style="<?php echo $sStyleHidden_funcao_id; ?>"><span id="id_label_funcao_id"><?php echo $this->nm_new_label['funcao_id']; ?></span></TD>
