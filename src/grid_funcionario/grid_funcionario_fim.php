...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["com210_____grid_funcionario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["com210_____grid_funcionario"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_funcionario'] = array();
   $fecha_janela = false;
