...
function Sel_cmp_process()
{
   ...
   function Sel_cmp_init_fields()
   {
      ...
      $tab_blk_campos[] = "funcao_id";
      $tab_ger_campos['ativo'] = "on";
      $tab_blk_campos[] = "ativo";
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$this->sc_init]['grid_funcionario']['usr_cmp_sel']) && isset($_SESSION['sc_session'][$this->sc_init]['grid_funcionario']['usr_cmp_sel_orig']) && $_SESSION['sc_session'][$this->sc_init]['grid_funcionario']['usr_cmp_sel'] != $_SESSION['sc_session'][$this->sc_init]['grid_funcionario']['usr_cmp_sel_orig']) {
      $disp_rest = "";
  }
  else {
      $order_orig = array();
