<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp'] . "/sc_apl_default_com210.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["nome"] : "Nome";
   $tab_ger_campos['cpf'] = "on";
   $tab_def_campos['cpf'] = "cpf";
   $tab_labels["cpf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["cpf"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["cpf"] : "CPF";
   $tab_ger_campos['matricula'] = "on";
   $tab_def_campos['matricula'] = "matricula";
   $tab_labels["matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["matricula"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["matricula"] : "Matrícula";
   $tab_ger_campos['telefone'] = "on";
   $tab_def_campos['telefone'] = "telefone";
   $tab_labels["telefone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["telefone"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["telefone"] : "Telefone";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["email"] : "E-mail";
   $tab_ger_campos['data_nascimento'] = "on";
   $tab_def_campos['data_nascimento'] = "data_nascimento";
   $tab_labels["data_nascimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["data_nascimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["data_nascimento"] : "Data de Nascimento";
   $tab_ger_campos['funcao_id'] = "on";
   $tab_def_campos['funcao_id'] = "funcao_id";
   $tab_labels["funcao_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["funcao_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["funcao_id"] : "Função";
   $tab_ger_campos['ativo'] = "on";
   $tab_def_campos['ativo'] = "ativo";
   $tab_labels["ativo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["ativo"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["ativo"] : "Ativo";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_funcionario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_funcionario']['ordem_quebra'][$campo][$sqldef] = $ordem;
