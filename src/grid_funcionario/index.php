<?php
   ...
   $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_doc']        = "";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_funcionario']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_funcionario']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_funcionario']['save_session']['data'] = '';
      } 
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_funcionario']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_funcionario']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['grid_funcionario']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_funcionario']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_funcionario']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      ...
      $Tmp_apl_lig = "form_funcionario";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_funcionario_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_funcionario_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_funcionario_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_funcionario_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["form_funcionario"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = '';
      $this->sc_lig_target["A_@scinf__@scinf_form_funcionario"] = '';
      ...
      $this->link_form_funcionario =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_funcionario') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_funcionario']['glo_nm_conexao'], $this->root . $this->path_prod, 'com210', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          {
              $_SESSION['i'] = $i;
              nm_limpa_str_grid_funcionario($_SESSION["i"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              ...
              if (($_POST['opc'] == "igual" || $_POST['opc'] == "resumo") && isset($_POST['parm']) && ($_POST['parm'] == "reload" || $_POST['parm'] == "breload"))
              {
                  ...
                  $_SESSION['sc_session'][$script_case_init]['grid_funcionario']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['pivot_tabular']);
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "nome";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "cpf";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "matricula";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "telefone";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "email";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "data_nascimento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "funcao_id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "ativo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "id";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['usr_cmp_sel']['id'] = "off";
      ...
      { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_refresh'] = true;
          } 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['opcao'] == "interativ_search")
      { 
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['opcao'] = 'inicio';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_refresh'] = true;
      } 
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['contr_total_geral'] = "NAO";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_funcionario.pdf";
...
//----------------------------------->
      ...
      { 
          ...
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['word_name'] .= ".doc";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_funcionario/grid_funcionario_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_funcionario_json.class.php"); 
          } 
          $this->json  = new grid_funcionario_json();
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_funcionario_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
            ...
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['pdf_name'], 1);
                }
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_funcionario_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_funcionario_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
$downloadFileName = "grid_funcionario.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'] . ")"; 
              }
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['fast_search'][0] = $in_fields;
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['SC_sep_date']))
      {
          $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['SC_sep_date'];
          $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['SC_sep_date1'];
      }
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] != "clear_interativ")
       {
           ...
           if ($tmp[2] == "dt" || $tmp[2] == "dh" || $tmp[2] == "hh")
           {
               ...
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['SC_sep_date']))
               {
                   $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['SC_sep_date'];
                   $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['SC_sep_date1'];
               }
           }
       }
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_search'][$tmp[0]]);
       if (!empty($vls))
       {
           $prep = "";
           $bol_has_empty = false;
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_postgres))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
               }
           }
           elseif ($prep == "" && $delim != "")
           {
           ...
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
       }
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_orig'])) 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_fast'] . ")";
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'] .= " and ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_interativ'])) 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp'] . "/sc_apl_default_com210.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp'] . "/sc_apl_default_com210.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_com210'])) {
               $_SESSION['scriptcase']['grid_funcionario']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_com210'];
           }
       }
   }
   ...
   { 
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_funcionario']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_funcionario']['mostra_edit'] = "S";
       }
...
//
   ...
   function grid_funcionario_pack_protect_string($sString)
   {
    ...
    function grid_funcionario_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
