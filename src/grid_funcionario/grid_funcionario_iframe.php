...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_funcionario']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_funcionario']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_funcionario']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "N";
...
<?php
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_funcionario']['pdf_name'])) {
    $Pos = strrpos($_SESSION['sc_session'][$aParams['script_case_init']]['grid_funcionario']['pdf_name'], ".");
    if ($Pos === false) {
        $_SESSION['sc_session'][$aParams['script_case_init']]['grid_funcionario']['pdf_name'] .= ".pdf";
    }
}
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_funcionario']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_funcionario']['pdf_name'] : 'sc_pdf_' . md5(date('Ymd') . '_' . session_id()) . '_grid_funcionario.pdf';
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_funcionario'][$path_doc_md5][0] = $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp'] . "/" . $NM_tit_doc;
