  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_registros_soltura" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_registros_soltura_form();
	}
  ...
  // ---------- Validate detento_id
  function do_ajax_form_registros_soltura_validate_detento_id()
  {
    var nomeCampo_detento_id = "detento_id";
    var var_detento_id = scAjaxGetFieldSelect(nomeCampo_detento_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_registros_soltura_validate_detento_id(var_detento_id, var_script_case_init, do_ajax_form_registros_soltura_validate_detento_id_cb);
  } // do_ajax_form_registros_soltura_validate_detento_id

  function do_ajax_form_registros_soltura_validate_detento_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_registros_soltura_validate_detento_id_cb

  // ---------- Validate motivo
  function do_ajax_form_registros_soltura_validate_motivo()
  {
    var nomeCampo_motivo = "motivo";
    var var_motivo = scAjaxGetFieldSelect(nomeCampo_motivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_registros_soltura_validate_motivo(var_motivo, var_script_case_init, do_ajax_form_registros_soltura_validate_motivo_cb);
  } // do_ajax_form_registros_soltura_validate_motivo

  function do_ajax_form_registros_soltura_validate_motivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "motivo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_registros_soltura_validate_motivo_cb

  // ---------- Validate data
  function do_ajax_form_registros_soltura_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_registros_soltura_validate_data(var_data, var_script_case_init, do_ajax_form_registros_soltura_validate_data_cb);
  } // do_ajax_form_registros_soltura_validate_data

  function do_ajax_form_registros_soltura_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_registros_soltura_validate_data_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_registros_soltura_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_registros_soltura_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_registros_soltura_submit_form(var_detento_id, var_motivo, var_data, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_registros_soltura_submit_form_cb);
  } // do_ajax_form_registros_soltura_submit_form

  function do_ajax_form_registros_soltura_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_registros_soltura_submit_form_cb_after_alert);
  } // do_ajax_form_registros_soltura_submit_form_cb
  function do_ajax_form_registros_soltura_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_registros_soltura_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_registros_soltura_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_registros_soltura_navigate_form, function() {});
    } else {
      perform_ajax_form_registros_soltura_navigate_form();
    }
  }

  function perform_ajax_form_registros_soltura_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_registros_soltura_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_registros_soltura_navigate_form_cb);
  } // do_ajax_form_registros_soltura_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_registros_soltura']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_registros_soltura_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_registros_soltura_navigate_form_cb_after_alert);
  } // do_ajax_form_registros_soltura_navigate_form_cb
  function do_ajax_form_registros_soltura_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_registros_soltura_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_registros_soltura_navigate_form_cb_after_alert
  function sc_hide_form_registros_soltura_form()
  {
