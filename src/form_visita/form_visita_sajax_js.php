  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_visita" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_visita_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visita_validate_id(var_id, var_script_case_init, do_ajax_form_visita_validate_id_cb);
  } // do_ajax_form_visita_validate_id

  function do_ajax_form_visita_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visita_validate_id_cb

  // ---------- Validate nome
  function do_ajax_form_visita_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visita_validate_nome(var_nome, var_script_case_init, do_ajax_form_visita_validate_nome_cb);
  } // do_ajax_form_visita_validate_nome

  function do_ajax_form_visita_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visita_validate_nome_cb

  // ---------- Validate cpf
  function do_ajax_form_visita_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldText(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visita_validate_cpf(var_cpf, var_script_case_init, do_ajax_form_visita_validate_cpf_cb);
  } // do_ajax_form_visita_validate_cpf

  function do_ajax_form_visita_validate_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cpf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visita_validate_cpf_cb

  // ---------- Validate data_nascimento
  function do_ajax_form_visita_validate_data_nascimento()
  {
  ...
  function do_ajax_form_visita_validate_data_nascimento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visita_validate_data_nascimento_cb

  // ---------- Validate tipo_id
  function do_ajax_form_visita_validate_tipo_id()
  {
    var nomeCampo_tipo_id = "tipo_id";
    var var_tipo_id = scAjaxGetFieldSelect(nomeCampo_tipo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visita_validate_tipo_id(var_tipo_id, var_script_case_init, do_ajax_form_visita_validate_tipo_id_cb);
  } // do_ajax_form_visita_validate_tipo_id

  function do_ajax_form_visita_validate_tipo_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visita_validate_tipo_id_cb

  // ---------- Validate objetos
  function do_ajax_form_visita_validate_objetos()
  {
    var nomeCampo_objetos = "objetos";
    var var_objetos = scAjaxGetFieldText(nomeCampo_objetos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visita_validate_objetos(var_objetos, var_script_case_init, do_ajax_form_visita_validate_objetos_cb);
  } // do_ajax_form_visita_validate_objetos

  function do_ajax_form_visita_validate_objetos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "objetos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visita_validate_objetos_cb

  // ---------- Validate data_visita
  function do_ajax_form_visita_validate_data_visita()
  {
    var nomeCampo_data_visita = "data_visita";
    var var_data_visita = scAjaxGetFieldText(nomeCampo_data_visita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visita_validate_data_visita(var_data_visita, var_script_case_init, do_ajax_form_visita_validate_data_visita_cb);
  } // do_ajax_form_visita_validate_data_visita

  function do_ajax_form_visita_validate_data_visita_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visita_validate_data_visita_cb

  // ---------- Validate detento_id
  function do_ajax_form_visita_validate_detento_id()
  {
    var nomeCampo_detento_id = "detento_id";
    var var_detento_id = scAjaxGetFieldSelect(nomeCampo_detento_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visita_validate_detento_id(var_detento_id, var_script_case_init, do_ajax_form_visita_validate_detento_id_cb);
  } // do_ajax_form_visita_validate_detento_id

  function do_ajax_form_visita_validate_detento_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visita_validate_detento_id_cb

  // ---------- Validate status_id
  function do_ajax_form_visita_validate_status_id()
  {
    var nomeCampo_status_id = "status_id";
    var var_status_id = scAjaxGetFieldSelect(nomeCampo_status_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_visita_validate_status_id(var_status_id, var_script_case_init, do_ajax_form_visita_validate_status_id_cb);
  } // do_ajax_form_visita_validate_status_id

  function do_ajax_form_visita_validate_status_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_visita_validate_status_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_visita_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_visita_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_visita_submit_form(var_id, var_nome, var_cpf, var_data_nascimento, var_tipo_id, var_objetos, var_data_visita, var_detento_id, var_status_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_visita_submit_form_cb);
  } // do_ajax_form_visita_submit_form

  function do_ajax_form_visita_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_visita_submit_form_cb_after_alert);
  } // do_ajax_form_visita_submit_form_cb
  function do_ajax_form_visita_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_visita_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_visita_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_visita_navigate_form, function() {});
    } else {
      perform_ajax_form_visita_navigate_form();
    }
  }

  function perform_ajax_form_visita_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_visita_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_visita_navigate_form_cb);
  } // do_ajax_form_visita_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_visita']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_visita_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_visita_navigate_form_cb_after_alert);
  } // do_ajax_form_visita_navigate_form_cb
  function do_ajax_form_visita_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_visita_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_visita_navigate_form_cb_after_alert
  function sc_hide_form_visita_form()
  {
