...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_visita']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_visita"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_excluir_visita = false;
function sc_btn_excluir_visita()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_excluir_visita(); }, 500);
      return;
    }
...
function sc_btn_excluir_visita_ok()
{
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_visita']['where_detal']))
  {
?>  
