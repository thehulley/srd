<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_perfil']          = "conn_mysql";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'com210', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_groups']['field_order'][] = "id";
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_com210.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_com210.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_com210'])) {
               $_SESSION['scriptcase']['app_grid_sec_groups']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_com210'];
           }
       }
   }
