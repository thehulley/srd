...
//
   ...
   { 
       ...
       $this->privilegio_admin = $Busca_temp['privilegio_admin']; 
       $tmp_pos = strpos($this->privilegio_admin, "##@@");
       if ($tmp_pos !== false && !is_array($this->privilegio_admin))
       {
           $this->privilegio_admin = substr($this->privilegio_admin, 0, $tmp_pos);
       }
   } 
   ...
   $this->New_label['privilegio_admin'] = "" . $this->Ini->Nm_lang['lang_sec_users_fild_priv_admin'] . "";
...
// 
 ...
 function NM_label_matricula()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['ordem_cmp'] == 'matricula')
      {
...
// 
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['mostra_edit'] != "N"){ 
              ...
              {
                  $Parms_Edt  = "matricula*scin" . $this->matricula . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutnmgp_opcao*scinigual*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scoutNMSC_modal*scinok*scout";
              ...
              {
                  $Md5_Edt  = "matricula*scin" . $this->matricula . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutnmgp_opcao*scinigual*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scoutNMSC_modal*scinok*scout";
              }
