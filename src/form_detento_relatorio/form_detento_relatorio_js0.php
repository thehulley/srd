<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="matricula" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['matricula']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_detento_relatorio']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_detento_relatorio"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detento_relatorio']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("nome=disabled;cpf=disabled;data_nascimento=disabled;data_inicio_pena=disabled;status_id=disabled;data=disabled", "");
