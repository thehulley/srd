  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detento_relatorio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detento_relatorio_form();
	}
  ...
  // ---------- Validate nome
  function do_ajax_form_detento_relatorio_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detento_relatorio_validate_nome(var_nome, var_script_case_init, do_ajax_form_detento_relatorio_validate_nome_cb);
  } // do_ajax_form_detento_relatorio_validate_nome

  function do_ajax_form_detento_relatorio_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detento_relatorio_validate_nome_cb

  // ---------- Validate matricula
  function do_ajax_form_detento_relatorio_validate_matricula()
  {
    var nomeCampo_matricula = "matricula";
    var var_matricula = scAjaxGetFieldText(nomeCampo_matricula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detento_relatorio_validate_matricula(var_matricula, var_script_case_init, do_ajax_form_detento_relatorio_validate_matricula_cb);
  } // do_ajax_form_detento_relatorio_validate_matricula

  function do_ajax_form_detento_relatorio_validate_matricula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detento_relatorio_validate_matricula_cb

  // ---------- Validate cpf
  function do_ajax_form_detento_relatorio_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldText(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detento_relatorio_validate_cpf(var_cpf, var_script_case_init, do_ajax_form_detento_relatorio_validate_cpf_cb);
  } // do_ajax_form_detento_relatorio_validate_cpf

  function do_ajax_form_detento_relatorio_validate_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cpf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detento_relatorio_validate_cpf_cb

  // ---------- Validate data_nascimento
  function do_ajax_form_detento_relatorio_validate_data_nascimento()
  {
    ...
    setTimeout(function() {
      var var_data_nascimento = scAjaxGetFieldText(nomeCampo_data_nascimento);
      x_ajax_form_detento_relatorio_validate_data_nascimento(var_data_nascimento, var_script_case_init, do_ajax_form_detento_relatorio_validate_data_nascimento_cb);
    }, 200);
  } // do_ajax_form_detento_relatorio_validate_data_nascimento

  function do_ajax_form_detento_relatorio_validate_data_nascimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detento_relatorio_validate_data_nascimento_cb

  // ---------- Validate data_inicio_pena
  function do_ajax_form_detento_relatorio_validate_data_inicio_pena()
  {
    ...
    setTimeout(function() {
      var var_data_inicio_pena = scAjaxGetFieldText(nomeCampo_data_inicio_pena);
      x_ajax_form_detento_relatorio_validate_data_inicio_pena(var_data_inicio_pena, var_script_case_init, do_ajax_form_detento_relatorio_validate_data_inicio_pena_cb);
    }, 200);
  } // do_ajax_form_detento_relatorio_validate_data_inicio_pena

  function do_ajax_form_detento_relatorio_validate_data_inicio_pena_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detento_relatorio_validate_data_inicio_pena_cb

  // ---------- Validate status_id
  function do_ajax_form_detento_relatorio_validate_status_id()
  {
    var nomeCampo_status_id = "status_id";
    var var_status_id = scAjaxGetFieldSelect(nomeCampo_status_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detento_relatorio_validate_status_id(var_status_id, var_script_case_init, do_ajax_form_detento_relatorio_validate_status_id_cb);
  } // do_ajax_form_detento_relatorio_validate_status_id

  function do_ajax_form_detento_relatorio_validate_status_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detento_relatorio_validate_status_id_cb

  // ---------- Validate data
  function do_ajax_form_detento_relatorio_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detento_relatorio_validate_data(var_data, var_script_case_init, do_ajax_form_detento_relatorio_validate_data_cb);
  } // do_ajax_form_detento_relatorio_validate_data

  function do_ajax_form_detento_relatorio_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detento_relatorio_validate_data_cb

  // ---------- Validate crimes
  function do_ajax_form_detento_relatorio_validate_crimes()
  {
    var nomeCampo_crimes = "crimes";
    var var_crimes = scAjaxGetFieldText(nomeCampo_crimes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detento_relatorio_validate_crimes(var_crimes, var_script_case_init, do_ajax_form_detento_relatorio_validate_crimes_cb);
  } // do_ajax_form_detento_relatorio_validate_crimes

  function do_ajax_form_detento_relatorio_validate_crimes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "crimes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detento_relatorio_validate_crimes_cb

  // ---------- Event onchange cpf
  function do_ajax_form_detento_relatorio_event_cpf_onchange()
  {
    var var_cpf = scAjaxGetFieldText("cpf");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detento_relatorio_event_cpf_onchange(var_cpf, var_script_case_init, do_ajax_form_detento_relatorio_event_cpf_onchange_cb);
  } // do_ajax_form_detento_relatorio_event_cpf_onchange

  function do_ajax_form_detento_relatorio_event_cpf_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detento_relatorio_event_cpf_onchange_cb_after_alert);
  } // do_ajax_form_detento_relatorio_event_cpf_onchange_cb
  function do_ajax_form_detento_relatorio_event_cpf_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detento_relatorio_event_cpf_onchange_cb_after_alert

  // ---------- Event onchange matricula
  function do_ajax_form_detento_relatorio_event_matricula_onchange()
  {
    var var_matricula = scAjaxGetFieldText("matricula");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detento_relatorio_event_matricula_onchange(var_matricula, var_script_case_init, do_ajax_form_detento_relatorio_event_matricula_onchange_cb);
  } // do_ajax_form_detento_relatorio_event_matricula_onchange

  function do_ajax_form_detento_relatorio_event_matricula_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "matricula";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detento_relatorio_event_matricula_onchange_cb_after_alert);
  } // do_ajax_form_detento_relatorio_event_matricula_onchange_cb
  function do_ajax_form_detento_relatorio_event_matricula_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detento_relatorio_event_matricula_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_detento_relatorio_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_detento_relatorio_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_detento_relatorio_submit_form(var_nome, var_matricula, var_cpf, var_data_nascimento, var_data_inicio_pena, var_status_id, var_data, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detento_relatorio_submit_form_cb);
  } // do_ajax_form_detento_relatorio_submit_form

  function do_ajax_form_detento_relatorio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_detento_relatorio_submit_form_cb_after_alert);
  } // do_ajax_form_detento_relatorio_submit_form_cb
  function do_ajax_form_detento_relatorio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detento_relatorio_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_crimes_detento"] = "off";

  function do_ajax_form_detento_relatorio_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_detento_relatorio_navigate_form, function() {});
    } else {
      perform_ajax_form_detento_relatorio_navigate_form();
    }
  }

  function perform_ajax_form_detento_relatorio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_detento_relatorio_navigate_form(var_matricula, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detento_relatorio_navigate_form_cb);
  } // do_ajax_form_detento_relatorio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detento_relatorio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detento_relatorio_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detento_relatorio_navigate_form_cb_after_alert);
  } // do_ajax_form_detento_relatorio_navigate_form_cb
  function do_ajax_form_detento_relatorio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_detento_relatorio_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_detento_relatorio_navigate_form_cb_after_alert
  function sc_hide_form_detento_relatorio_form()
  {
