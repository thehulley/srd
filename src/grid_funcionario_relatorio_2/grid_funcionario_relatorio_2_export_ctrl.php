<?php
@session_start() ;
$_SESSION['scriptcase']['grid_funcionario_relatorio_2']['sc_process_barr'] = true;
require_once('../grid_funcionario_relatorio_2/index.php');
unset($_SESSION['scriptcase']['grid_funcionario_relatorio_2']['sc_process_barr']);
$ExportCtrl = new grid_funcionario_relatorio_2_export_control;
$ExportCtrl->Export_barr();

class grid_funcionario_relatorio_2_export_control
{
