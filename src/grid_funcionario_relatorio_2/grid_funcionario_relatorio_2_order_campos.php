...
<?php
   ...
   $Ord_Cmp = new grid_funcionario_relatorio_2_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_funcionario_relatorio_2_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["matricula"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["matricula"] : "Matrícula";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["nome"] : "Nome";
   $tab_ger_campos['funcao_id'] = "on";
   $tab_def_campos['funcao_id'] = "funcao_id";
   $tab_labels["funcao_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["funcao_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["funcao_id"] : "Função";
   $tab_ger_campos['setor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['setor'] = "setor";
   }
   else
   {
       $tab_def_campos['setor'] = "SELECT s.nome FROM funcao f INNER JOIN setor s ON f.setor = s.id WHERE f.id = {funcao_id}";
   }
   $tab_labels["setor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["setor"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["setor"] : "Setor";
   $tab_ger_campos['consultar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['consultar'] = "consultar";
   }
   else
   {
       $tab_def_campos['consultar'] = "";
   }
   $tab_labels["consultar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["consultar"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['labels']["consultar"] : "Consultar";
   $tab_ger_campos['setor'] = "none";
   $tab_ger_campos['consultar'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_funcionario_relatorio_2_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_funcionario_relatorio_2']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
