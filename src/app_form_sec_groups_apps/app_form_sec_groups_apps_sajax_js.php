...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate aplicacao_
  function do_ajax_app_form_sec_groups_apps_validate_aplicacao_(iNumLinha)
  {
  } // do_ajax_app_form_sec_groups_apps_validate_aplicacao_

  function do_ajax_app_form_sec_groups_apps_validate_aplicacao__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "aplicacao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "aplicacao_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "aplicacao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "aplicacao_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_apps_validate_aplicacao__cb

  // ---------- Validate acesso_
  function do_ajax_app_form_sec_groups_apps_validate_acesso_(iNumLinha)
  {
    var nomeCampo_acesso_ = "acesso_" + iNumLinha;
    var var_acesso_ = scAjaxGetFieldCheckbox(nomeCampo_acesso_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_apps_validate_acesso_(var_acesso_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_apps_validate_acesso__cb);
  } // do_ajax_app_form_sec_groups_apps_validate_acesso_

  function do_ajax_app_form_sec_groups_apps_validate_acesso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "acesso_" + iLineNumber;
    }
    else
    {
      sFieldValid = "acesso_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "acesso_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "acesso_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_apps_validate_acesso__cb

  // ---------- Validate insercao_
  function do_ajax_app_form_sec_groups_apps_validate_insercao_(iNumLinha)
  {
    var nomeCampo_insercao_ = "insercao_" + iNumLinha;
    var var_insercao_ = scAjaxGetFieldCheckbox(nomeCampo_insercao_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_apps_validate_insercao_(var_insercao_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_apps_validate_insercao__cb);
  } // do_ajax_app_form_sec_groups_apps_validate_insercao_

  function do_ajax_app_form_sec_groups_apps_validate_insercao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "insercao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "insercao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "insercao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "insercao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_apps_validate_insercao__cb

  // ---------- Validate remocao_
  function do_ajax_app_form_sec_groups_apps_validate_remocao_(iNumLinha)
  {
    var nomeCampo_remocao_ = "remocao_" + iNumLinha;
    var var_remocao_ = scAjaxGetFieldCheckbox(nomeCampo_remocao_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_apps_validate_remocao_(var_remocao_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_apps_validate_remocao__cb);
  } // do_ajax_app_form_sec_groups_apps_validate_remocao_

  function do_ajax_app_form_sec_groups_apps_validate_remocao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "remocao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "remocao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "remocao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "remocao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_apps_validate_remocao__cb

  // ---------- Validate atualizacao_
  function do_ajax_app_form_sec_groups_apps_validate_atualizacao_(iNumLinha)
  {
    var nomeCampo_atualizacao_ = "atualizacao_" + iNumLinha;
    var var_atualizacao_ = scAjaxGetFieldCheckbox(nomeCampo_atualizacao_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_apps_validate_atualizacao_(var_atualizacao_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_apps_validate_atualizacao__cb);
  } // do_ajax_app_form_sec_groups_apps_validate_atualizacao_

  function do_ajax_app_form_sec_groups_apps_validate_atualizacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "atualizacao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "atualizacao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "atualizacao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "atualizacao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_apps_validate_atualizacao__cb

  // ---------- Validate exportacao_
  function do_ajax_app_form_sec_groups_apps_validate_exportacao_(iNumLinha)
  {
    var nomeCampo_exportacao_ = "exportacao_" + iNumLinha;
    var var_exportacao_ = scAjaxGetFieldCheckbox(nomeCampo_exportacao_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_apps_validate_exportacao_(var_exportacao_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_apps_validate_exportacao__cb);
  } // do_ajax_app_form_sec_groups_apps_validate_exportacao_

  function do_ajax_app_form_sec_groups_apps_validate_exportacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "exportacao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "exportacao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "exportacao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "exportacao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_apps_validate_exportacao__cb

  // ---------- Validate impressao_
  function do_ajax_app_form_sec_groups_apps_validate_impressao_(iNumLinha)
  {
    var nomeCampo_impressao_ = "impressao_" + iNumLinha;
    var var_impressao_ = scAjaxGetFieldCheckbox(nomeCampo_impressao_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_apps_validate_impressao_(var_impressao_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_apps_validate_impressao__cb);
  } // do_ajax_app_form_sec_groups_apps_validate_impressao_

  function do_ajax_app_form_sec_groups_apps_validate_impressao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "impressao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "impressao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "impressao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "impressao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_apps_validate_impressao__cb
  ...
  function do_ajax_app_form_sec_groups_apps_backup_line(iNumLinha)
  {
    ...
    var var_aplicacao_ = scAjaxGetFieldHidden("aplicacao_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_apps_backup_line(var_grupo_id_, var_aplicacao_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_app_form_sec_groups_apps_backup_line_cb);
...
?>
  ...
  function do_ajax_app_form_sec_groups_apps_table_refresh()
  {
    ...
    var var_aplicacao_ = document.F2.aplicacao_.value;
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_groups_apps_table_refresh(var_grupo_id_, var_aplicacao_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_sec_groups_apps_table_refresh_cb);
  ...
  function do_ajax_app_form_sec_groups_apps_table_refresh_cb(sResp)
  {
    ...
    document.F2.aplicacao_.value = scAjaxGetKeyValue("aplicacao_");
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_sec_groups_apps_submit_form(iNumLinha, indexTR)
  {
    ...
    scAjaxHideMessage();
    var var_aplicacao_ = scAjaxGetFieldHidden("aplicacao_" + iNumLinha);
    var var_acesso_ = scAjaxGetFieldCheckbox("acesso_" + iNumLinha, ";");
    var var_insercao_ = scAjaxGetFieldCheckbox("insercao_" + iNumLinha, ";");
    var var_remocao_ = scAjaxGetFieldCheckbox("remocao_" + iNumLinha, ";");
    var var_atualizacao_ = scAjaxGetFieldCheckbox("atualizacao_" + iNumLinha, ";");
    var var_exportacao_ = scAjaxGetFieldCheckbox("exportacao_" + iNumLinha, ";");
    var var_impressao_ = scAjaxGetFieldCheckbox("impressao_" + iNumLinha, ";");
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_app_form_sec_groups_apps_submit_form(var_aplicacao_, var_acesso_, var_insercao_, var_remocao_, var_atualizacao_, var_exportacao_, var_impressao_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_sec_groups_apps_submit_form_cb);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("aplicacao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("acesso_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("insercao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("remocao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("atualizacao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("exportacao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("impressao_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
  ...
  function perform_ajax_app_form_sec_groups_apps_navigate_form()
  {
    ...
    {
      scAjaxHideErrorDisplay("aplicacao_" + iNavForm);
      scAjaxHideErrorDisplay("acesso_" + iNavForm);
      scAjaxHideErrorDisplay("insercao_" + iNavForm);
      scAjaxHideErrorDisplay("remocao_" + iNavForm);
      scAjaxHideErrorDisplay("atualizacao_" + iNavForm);
      scAjaxHideErrorDisplay("exportacao_" + iNavForm);
      scAjaxHideErrorDisplay("impressao_" + iNavForm);
    }
    var var_grupo_id_ = document.F2.grupo_id_.value;
    var var_aplicacao_ = document.F2.aplicacao_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_app_form_sec_groups_apps_navigate_form(var_grupo_id_, var_aplicacao_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_sec_groups_apps_navigate_form_cb);
...
?>
  function do_ajax_app_form_sec_groups_apps_navigate_form_cb(sResp)
  {
    ...
    $("#sc-ui-checkbox-acesso_-control").prop("checked", false);
    $("#sc-ui-checkbox-insercao_-control").prop("checked", false);
    $("#sc-ui-checkbox-remocao_-control").prop("checked", false);
    $("#sc-ui-checkbox-atualizacao_-control").prop("checked", false);
    $("#sc-ui-checkbox-exportacao_-control").prop("checked", false);
    $("#sc-ui-checkbox-impressao_-control").prop("checked", false);
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.grupo_id_.value = scAjaxGetKeyValue("grupo_id_" + var_last_index);
    document.F2.aplicacao_.value = scAjaxGetKeyValue("aplicacao_" + var_last_index);
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "aplicacao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "acesso_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "insercao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "remocao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "atualizacao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "exportacao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "impressao_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["aplicacao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_app_name'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["acesso_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_access'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["insercao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_insert'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["remocao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_delete'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["atualizacao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_update'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["exportacao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_export'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["impressao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_priv_print'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["aplicacao_"][iNumLinha] = "aplicacao_" + iNumLinha;
    ajax_field_mult["acesso_"][iNumLinha] = "acesso_" + iNumLinha;
    ajax_field_mult["insercao_"][iNumLinha] = "insercao_" + iNumLinha;
    ajax_field_mult["remocao_"][iNumLinha] = "remocao_" + iNumLinha;
    ajax_field_mult["atualizacao_"][iNumLinha] = "atualizacao_" + iNumLinha;
    ajax_field_mult["exportacao_"][iNumLinha] = "exportacao_" + iNumLinha;
    ajax_field_mult["impressao_"][iNumLinha] = "impressao_" + iNumLinha;
    ajax_field_id["aplicacao_" + iNumLinha] = new Array("hidden_field_label_aplicacao_", "hidden_field_data_aplicacao_" + iNumLinha);
    ajax_field_id["acesso_" + iNumLinha] = new Array("hidden_field_label_acesso_", "hidden_field_data_acesso_" + iNumLinha);
    ajax_field_id["insercao_" + iNumLinha] = new Array("hidden_field_label_insercao_", "hidden_field_data_insercao_" + iNumLinha);
    ajax_field_id["remocao_" + iNumLinha] = new Array("hidden_field_label_remocao_", "hidden_field_data_remocao_" + iNumLinha);
    ajax_field_id["atualizacao_" + iNumLinha] = new Array("hidden_field_label_atualizacao_", "hidden_field_data_atualizacao_" + iNumLinha);
    ajax_field_id["exportacao_" + iNumLinha] = new Array("hidden_field_label_exportacao_", "hidden_field_data_exportacao_" + iNumLinha);
    ajax_field_id["impressao_" + iNumLinha] = new Array("hidden_field_label_impressao_", "hidden_field_data_impressao_" + iNumLinha);
    ajax_error_count["aplicacao_" + iNumLinha] = "off";
    ajax_error_count["acesso_" + iNumLinha] = "off";
    ajax_error_count["insercao_" + iNumLinha] = "off";
    ajax_error_count["remocao_" + iNumLinha] = "off";
    ajax_error_count["atualizacao_" + iNumLinha] = "off";
    ajax_error_count["exportacao_" + iNumLinha] = "off";
    ajax_error_count["impressao_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["aplicacao_" + iNumLinha] = "off";
    ajax_read_only["acesso_" + iNumLinha] = "off";
    ajax_read_only["insercao_" + iNumLinha] = "off";
    ajax_read_only["remocao_" + iNumLinha] = "off";
    ajax_read_only["atualizacao_" + iNumLinha] = "off";
    ajax_read_only["exportacao_" + iNumLinha] = "off";
    ajax_read_only["impressao_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["aplicacao_" + iNumLinha] = "on";
    ajax_read_only["acesso_" + iNumLinha] = "on";
    ajax_read_only["insercao_" + iNumLinha] = "on";
    ajax_read_only["remocao_" + iNumLinha] = "on";
    ajax_read_only["atualizacao_" + iNumLinha] = "on";
    ajax_read_only["exportacao_" + iNumLinha] = "on";
    ajax_read_only["impressao_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["aplicacao_" + iNumLinha] = null;
    ajax_error_list["acesso_" + iNumLinha] = null;
    ajax_error_list["insercao_" + iNumLinha] = null;
    ajax_error_list["remocao_" + iNumLinha] = null;
    ajax_error_list["atualizacao_" + iNumLinha] = null;
    ajax_error_list["exportacao_" + iNumLinha] = null;
    ajax_error_list["impressao_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "aplicacao_": new Array(),
    "acesso_": new Array(),
    "insercao_": new Array(),
    "remocao_": new Array(),
    "atualizacao_": new Array(),
    "exportacao_": new Array(),
    "impressao_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["aplicacao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["aplicacao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["aplicacao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["aplicacao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["aplicacao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["acesso_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["acesso_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["acesso_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["acesso_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["acesso_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["insercao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["insercao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["insercao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["insercao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["insercao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["remocao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["remocao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["remocao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["remocao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["remocao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["atualizacao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["atualizacao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["atualizacao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["atualizacao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["atualizacao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["exportacao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["exportacao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["exportacao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["exportacao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["exportacao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["impressao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["impressao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["impressao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["impressao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["impressao_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['aplicacao_'])) ? $this->nmgp_cmp_readonly['aplicacao_'] : 'off';
?>
    scAjaxFieldRead("aplicacao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['acesso_'])) ? $this->nmgp_cmp_readonly['acesso_'] : 'off';
?>
    scAjaxFieldRead("acesso_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['insercao_'])) ? $this->nmgp_cmp_readonly['insercao_'] : 'off';
?>
    scAjaxFieldRead("insercao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['remocao_'])) ? $this->nmgp_cmp_readonly['remocao_'] : 'off';
?>
    scAjaxFieldRead("remocao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['atualizacao_'])) ? $this->nmgp_cmp_readonly['atualizacao_'] : 'off';
?>
    scAjaxFieldRead("atualizacao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['exportacao_'])) ? $this->nmgp_cmp_readonly['exportacao_'] : 'off';
?>
    scAjaxFieldRead("exportacao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['impressao_'])) ? $this->nmgp_cmp_readonly['impressao_'] : 'off';
?>
    scAjaxFieldRead("impressao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("aplicacao_" + iSeq, "on");
    scAjaxFieldRead("acesso_" + iSeq, "on");
    scAjaxFieldRead("insercao_" + iSeq, "on");
    scAjaxFieldRead("remocao_" + iSeq, "on");
    scAjaxFieldRead("atualizacao_" + iSeq, "on");
    scAjaxFieldRead("exportacao_" + iSeq, "on");
    scAjaxFieldRead("impressao_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["aplicacao_" + iRow] || "on" == ajax_error_count["acesso_" + iRow] || "on" == ajax_error_count["insercao_" + iRow] || "on" == ajax_error_count["remocao_" + iRow] || "on" == ajax_error_count["atualizacao_" + iRow] || "on" == ajax_error_count["exportacao_" + iRow] || "on" == ajax_error_count["impressao_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_aplicacao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_acesso_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_insercao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_remocao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_atualizacao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_exportacao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_impressao_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["aplicacao_" + iRow] && "off" == ajax_error_count["acesso_" + iRow] && "off" == ajax_error_count["insercao_" + iRow] && "off" == ajax_error_count["remocao_" + iRow] && "off" == ajax_error_count["atualizacao_" + iRow] && "off" == ajax_error_count["exportacao_" + iRow] && "off" == ajax_error_count["impressao_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["aplicacao_" + iRow] = "off";
        ajax_error_count["acesso_" + iRow] = "off";
        ajax_error_count["insercao_" + iRow] = "off";
        ajax_error_count["remocao_" + iRow] = "off";
        ajax_error_count["atualizacao_" + iRow] = "off";
        ajax_error_count["exportacao_" + iRow] = "off";
        ajax_error_count["impressao_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_aplicacao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_acesso_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_insercao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_remocao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_atualizacao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_exportacao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_impressao_" + iRow).removeClass("scFormErrorLine");
    }
  }
