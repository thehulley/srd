...
//----- 
   function ini_controle()
   {
      ...
      {
          if (isset($this->NM_ajax_info['param']['acesso_']))
          {
              $this->acesso_ = $this->NM_ajax_info['param']['acesso_'];
          }
          if (isset($this->NM_ajax_info['param']['aplicacao_']))
          {
              $this->aplicacao_ = $this->NM_ajax_info['param']['aplicacao_'];
          }
          if (isset($this->NM_ajax_info['param']['atualizacao_']))
          {
              $this->atualizacao_ = $this->NM_ajax_info['param']['atualizacao_'];
          }
          if (isset($this->NM_ajax_info['param']['csrf_token']))
          {
              $this->csrf_token = $this->NM_ajax_info['param']['csrf_token'];
          }
          if (isset($this->NM_ajax_info['param']['exportacao_']))
          {
              $this->exportacao_ = $this->NM_ajax_info['param']['exportacao_'];
          }
          if (isset($this->NM_ajax_info['param']['grupo_id_']))
          {
              $this->grupo_id_ = $this->NM_ajax_info['param']['grupo_id_'];
          }
          if (isset($this->NM_ajax_info['param']['impressao_']))
          {
              $this->impressao_ = $this->NM_ajax_info['param']['impressao_'];
          }
          if (isset($this->NM_ajax_info['param']['insercao_']))
          {
              $this->insercao_ = $this->NM_ajax_info['param']['insercao_'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['remocao_']))
          {
              $this->remocao_ = $this->NM_ajax_info['param']['remocao_'];
          }
      ...
      $this->sc_conv_var['aplicacao'] = "aplicacao_";
      $this->sc_conv_var['acesso'] = "acesso_";
      $this->sc_conv_var['insercao'] = "insercao_";
      $this->sc_conv_var['remocao'] = "remocao_";
      $this->sc_conv_var['atualizacao'] = "atualizacao_";
      $this->sc_conv_var['exportacao'] = "exportacao_";
      $this->sc_conv_var['impressao'] = "impressao_";
      if (!empty($_FILES))
      {
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 if ($cadapar[0] == "aplicacao_")
                 {
                     $this->NM_where_filter .= (empty($this->NM_where_filter)) ? "(" : " and ";
                     $this->NM_where_filter .= "aplicacao = '" . $this->aplicacao_ . "'";
                     $this->has_where_params = true;
                     $tem_where_parms        = true;
                 }
                 elseif ($cadapar[0] == "NM_where_filter")
...
if (!isset($this->sc_temp_group)) {$this->sc_temp_group = (isset($_SESSION['group'])) ? $_SESSION['group'] : "";}
 $str_sql = "SELECT descricao FROM funcao WHERE id = ".$this->Db->qstr( $this->sc_temp_group );
...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off';
      ...
      { 
         ...
         { 
             if ($this->grupo_id_ != "" || $this->aplicacao_ != "")   
             { 
...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off'; 
   ...
   function controle()
   {
      ...
      {
         if (isset($this->aplicacao_)) { $this->nm_limpa_alfa($this->aplicacao_); }
         if (isset($this->acesso_)) { $this->nm_limpa_alfa($this->acesso_); }
         if (isset($this->insercao_)) { $this->nm_limpa_alfa($this->insercao_); }
         if (isset($this->remocao_)) { $this->nm_limpa_alfa($this->remocao_); }
         if (isset($this->atualizacao_)) { $this->nm_limpa_alfa($this->atualizacao_); }
         if (isset($this->exportacao_)) { $this->nm_limpa_alfa($this->exportacao_); }
         if (isset($this->impressao_)) { $this->nm_limpa_alfa($this->impressao_); }
      ...
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
         ...
         $Campos_Falta = array();
         $Campos_Erros = array();
          if ('validate_acesso_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'acesso_');
          }
          if ('validate_insercao_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'insercao_');
          }
          if ('validate_remocao_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'remocao_');
          }
          if ('validate_atualizacao_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'atualizacao_');
          }
          if ('validate_exportacao_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'exportacao_');
          }
          if ('validate_impressao_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'impressao_');
          }
          app_form_sec_groups_apps_pack_ajax_response();
          exit;
      }
      ...
      { 
         ...
         $Campos_Falta = array();
         $Campos_Erros = array();
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["exportacao_" . $sc_seq_vert]))
         { 
             $GLOBALS["exportacao_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['exportacao_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["impressao_" . $sc_seq_vert]))
         { 
             $GLOBALS["impressao_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['impressao_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["insercao_" . $sc_seq_vert]))
         { 
             $GLOBALS["insercao_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['insercao_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["remocao_" . $sc_seq_vert]))
         { 
             $GLOBALS["remocao_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['remocao_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["atualizacao_" . $sc_seq_vert]))
         { 
             $GLOBALS["atualizacao_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['atualizacao_'];
         } 
         $this->aplicacao_ = $GLOBALS["aplicacao_" . $sc_seq_vert]; 
         $this->acesso_ = $GLOBALS["acesso_" . $sc_seq_vert]; 
         $this->insercao_ = $GLOBALS["insercao_" . $sc_seq_vert]; 
         $this->remocao_ = $GLOBALS["remocao_" . $sc_seq_vert]; 
         $this->atualizacao_ = $GLOBALS["atualizacao_" . $sc_seq_vert]; 
         $this->exportacao_ = $GLOBALS["exportacao_" . $sc_seq_vert]; 
         $this->impressao_ = $GLOBALS["impressao_" . $sc_seq_vert]; 
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_form'][$sc_seq_vert];
             $this->grupo_id_ = $this->nmgp_dados_form['grupo_id_']; 
         ...
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['exportacao_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['exportacao_']))
             { 
                 $this->exportacao_ = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['exportacao_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['impressao_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['impressao_']))
             { 
                 $this->impressao_ = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['impressao_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['insercao_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['insercao_']))
             { 
                 $this->insercao_ = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['insercao_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['remocao_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['remocao_']))
             { 
                 $this->remocao_ = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['remocao_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['atualizacao_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['atualizacao_']))
             { 
                 $this->atualizacao_ = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['atualizacao_'];
             } 
             ...
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['aplicacao_'] =  $this->aplicacao_; 
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['acesso_'] =  $this->acesso_; 
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['insercao_'] =  $this->insercao_; 
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['remocao_'] =  $this->remocao_; 
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['atualizacao_'] =  $this->atualizacao_; 
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['exportacao_'] =  $this->exportacao_; 
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['impressao_'] =  $this->impressao_; 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['fldList']['aplicacao_']['keyVal'] = sc_htmlentities($this->nmgp_dados_form['aplicacao_']);
          $this->NM_close_db();
          app_form_sec_groups_apps_pack_ajax_response();
          exit;
      }
...
//
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          if (is_array($this->acesso_))
          {
              ...
              if ($this->acesso__1 != "") 
              { 
                  foreach ($this->acesso__1 as $dados_acesso__1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->acesso_ .= ";";
                      } 
                      $this->acesso_ .= $dados_acesso__1;
                      $x++ ; 
                  } 
              } 
          } 
          if (is_array($this->insercao_))
          {
              $x = 0; 
              ...
              if ($this->insercao__1 != "") 
              { 
                  foreach ($this->insercao__1 as $dados_insercao__1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->insercao_ .= ";";
                      } 
                      $this->insercao_ .= $dados_insercao__1;
                      $x++ ; 
                  } 
              } 
          } 
          if (is_array($this->remocao_))
          {
              $x = 0; 
              ...
              if ($this->remocao__1 != "") 
              { 
                  foreach ($this->remocao__1 as $dados_remocao__1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->remocao_ .= ";";
                      } 
                      $this->remocao_ .= $dados_remocao__1;
                      $x++ ; 
                  } 
              } 
          } 
          if (is_array($this->atualizacao_))
          {
              $x = 0; 
              $this->atualizacao__1 = $this->atualizacao_;
              $this->atualizacao_ = ""; 
              if ($this->atualizacao__1 != "") 
              { 
                  foreach ($this->atualizacao__1 as $dados_atualizacao__1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->atualizacao_ .= ";";
                      } 
                      $this->atualizacao_ .= $dados_atualizacao__1;
                      $x++ ; 
                  } 
              } 
          } 
          if (is_array($this->exportacao_))
          {
              $x = 0; 
              $this->exportacao__1 = $this->exportacao_;
              $this->exportacao_ = ""; 
              if ($this->exportacao__1 != "") 
              { 
                  foreach ($this->exportacao__1 as $dados_exportacao__1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->exportacao_ .= ";";
                      } 
                      $this->exportacao_ .= $dados_exportacao__1;
                      $x++ ; 
                  } 
              } 
          } 
          if (is_array($this->impressao_))
          {
              $x = 0; 
              $this->impressao__1 = $this->impressao_;
              $this->impressao_ = ""; 
              if ($this->impressao__1 != "") 
              { 
                  foreach ($this->impressao__1 as $dados_impressao__1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->impressao_ .= ";";
                      } 
                      $this->impressao_ .= $dados_impressao__1;
                      $x++ ; 
                  } 
              } 
          } 
          if (isset($this->exportacao_))
          { 
              $SV_exportacao_ = $this->exportacao_;
          } 
          if (isset($this->impressao_))
          { 
              $SV_impressao_ = $this->impressao_;
          } 
          if (isset($this->insercao_))
          { 
              $SV_insercao_ = $this->insercao_;
          } 
          if (isset($this->remocao_))
          { 
              $SV_remocao_ = $this->remocao_;
          } 
          if (isset($this->atualizacao_))
          { 
              $SV_atualizacao_ = $this->atualizacao_;
          } 
          $this->nm_tira_formatacao();
          if (isset($SV_exportacao_) && $this->nmgp_opcao != "recarga")
          { 
              $this->exportacao_ = $SV_exportacao_;
          } 
          if (isset($SV_impressao_) && $this->nmgp_opcao != "recarga")
          { 
              $this->impressao_ = $SV_impressao_;
          } 
          if (isset($SV_insercao_) && $this->nmgp_opcao != "recarga")
          { 
              $this->insercao_ = $SV_insercao_;
          } 
          if (isset($SV_remocao_) && $this->nmgp_opcao != "recarga")
          { 
              $this->remocao_ = $SV_remocao_;
          } 
          if (isset($SV_atualizacao_) && $this->nmgp_opcao != "recarga")
          { 
              $this->atualizacao_ = $SV_atualizacao_;
          } 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ('' == $filtro || 'acesso_' == $filtro)
        $this->ValidateField_acesso_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'insercao_' == $filtro)
        $this->ValidateField_insercao_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'remocao_' == $filtro)
        $this->ValidateField_remocao_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'atualizacao_' == $filtro)
        $this->ValidateField_atualizacao_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'exportacao_' == $filtro)
        $this->ValidateField_exportacao_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'impressao_' == $filtro)
        $this->ValidateField_impressao_($Campos_Crit, $Campos_Falta, $Campos_Erros);
    ...
    function ValidateField_acesso_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->acesso_ == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      else 
      { 
          if (is_array($this->acesso_))
          {
              ...
              foreach ($this->acesso_ as $ind => $dados_acesso__1 ) 
              {
                  if ($dados_acesso__1 != "") 
                  {
                      $this->acesso__1[] = $dados_acesso__1;
                  } 
              } 
              $this->acesso_ = ""; 
              foreach ($this->acesso__1 as $dados_acesso__1 ) 
    ...
    } // ValidateField_acesso_

    function ValidateField_insercao_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->insercao_ == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      else 
      { 
          if (is_array($this->insercao_))
          {
              ...
              foreach ($this->insercao_ as $ind => $dados_insercao__1 ) 
              {
                  if ($dados_insercao__1 != "") 
                  {
                      $this->insercao__1[] = $dados_insercao__1;
                  } 
              } 
              $this->insercao_ = ""; 
              foreach ($this->insercao__1 as $dados_insercao__1 ) 
    ...
    } // ValidateField_insercao_

    function ValidateField_remocao_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->remocao_ == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      else 
      { 
          if (is_array($this->remocao_))
          {
              ...
              foreach ($this->remocao_ as $ind => $dados_remocao__1 ) 
              {
                  if ($dados_remocao__1 != "") 
                  {
                      $this->remocao__1[] = $dados_remocao__1;
                  } 
              } 
              $this->remocao_ = ""; 
              foreach ($this->remocao__1 as $dados_remocao__1 ) 
    ...
    } // ValidateField_remocao_

    function ValidateField_atualizacao_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->atualizacao_ == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      else 
      { 
          if (is_array($this->atualizacao_))
          {
              ...
              foreach ($this->atualizacao_ as $ind => $dados_atualizacao__1 ) 
              {
                  if ($dados_atualizacao__1 != "") 
                  {
                      $this->atualizacao__1[] = $dados_atualizacao__1;
                  } 
              } 
              $this->atualizacao_ = ""; 
              foreach ($this->atualizacao__1 as $dados_atualizacao__1 ) 
        ...
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'atualizacao_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_atualizacao_

    function ValidateField_exportacao_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->exportacao_ == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      else 
      { 
          if (is_array($this->exportacao_))
          {
              ...
              foreach ($this->exportacao_ as $ind => $dados_exportacao__1 ) 
              {
                  if ($dados_exportacao__1 != "") 
                  {
                      $this->exportacao__1[] = $dados_exportacao__1;
                  } 
              } 
              $this->exportacao_ = ""; 
              foreach ($this->exportacao__1 as $dados_exportacao__1 ) 
        ...
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'exportacao_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_exportacao_

    function ValidateField_impressao_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->impressao_ == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      else 
      { 
          if (is_array($this->impressao_))
          {
              ...
              foreach ($this->impressao_ as $ind => $dados_impressao__1 ) 
              {
                  if ($dados_impressao__1 != "") 
                  {
                      $this->impressao__1[] = $dados_impressao__1;
                  } 
              } 
              $this->impressao_ = ""; 
              foreach ($this->impressao__1 as $dados_impressao__1 ) 
        ...
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'impressao_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_impressao_
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['aplicacao_'] = $this->aplicacao_;
    $this->nmgp_dados_form['acesso_'] = $this->acesso_;
    $this->nmgp_dados_form['insercao_'] = $this->insercao_;
    $this->nmgp_dados_form['remocao_'] = $this->remocao_;
    $this->nmgp_dados_form['atualizacao_'] = $this->atualizacao_;
    $this->nmgp_dados_form['exportacao_'] = $this->exportacao_;
    $this->nmgp_dados_form['impressao_'] = $this->impressao_;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['aplicacao_']['keyVal'] = app_form_sec_groups_apps_pack_protect_string($this->nmgp_dados_form['aplicacao_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          if (isset($this->nmgp_refresh_fields) && isset($this->nmgp_refresh_row) && '' != $this->nmgp_refresh_row)
          {
              ...
              {
                  if (isset($this->NM_ajax_changed['aplicacao_']) && $this->NM_ajax_changed['aplicacao_'])
                  {
                      $this->form_vert_app_form_sec_groups_apps[$this->nmgp_refresh_row]['aplicacao_'] = $this->aplicacao_;
                  }
                  if (isset($this->NM_ajax_changed['acesso_']) && $this->NM_ajax_changed['acesso_'])
                  {
                      $this->form_vert_app_form_sec_groups_apps[$this->nmgp_refresh_row]['acesso_'] = $this->acesso_;
                  }
                  if (isset($this->NM_ajax_changed['insercao_']) && $this->NM_ajax_changed['insercao_'])
                  {
                      $this->form_vert_app_form_sec_groups_apps[$this->nmgp_refresh_row]['insercao_'] = $this->insercao_;
                  }
                  if (isset($this->NM_ajax_changed['remocao_']) && $this->NM_ajax_changed['remocao_'])
                  {
                      $this->form_vert_app_form_sec_groups_apps[$this->nmgp_refresh_row]['remocao_'] = $this->remocao_;
                  }
                  if (isset($this->NM_ajax_changed['atualizacao_']) && $this->NM_ajax_changed['atualizacao_'])
                  {
                      $this->form_vert_app_form_sec_groups_apps[$this->nmgp_refresh_row]['atualizacao_'] = $this->atualizacao_;
                  }
                  if (isset($this->NM_ajax_changed['exportacao_']) && $this->NM_ajax_changed['exportacao_'])
                  {
                      $this->form_vert_app_form_sec_groups_apps[$this->nmgp_refresh_row]['exportacao_'] = $this->exportacao_;
                  }
                  if (isset($this->NM_ajax_changed['impressao_']) && $this->NM_ajax_changed['impressao_'])
                  {
                      $this->form_vert_app_form_sec_groups_apps[$this->nmgp_refresh_row]['impressao_'] = $this->impressao_;
                  }
              }
          }
          ...
          foreach($this->form_vert_app_form_sec_groups_apps as $sc_seq_vert => $aRecData)
          {
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("aplicacao_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['aplicacao_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  if (empty($aRecData['aplicacao_']))
                  {
                      $aRecData['aplicacao_'] = "";
                  }
                  $this->NM_ajax_info['fldList']['aplicacao_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'label',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("acesso_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['acesso_']);
                  $aLookup = array();
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_acesso_'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['acesso_']) && !empty($this->NM_ajax_info['select_html']['acesso_']))
          {
              eval("\$sOptComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['acesso_']) . "\";");
          }
                  $this->NM_ajax_info['fldList']['acesso_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'checkbox',
                       'switch'  => false,
               ...
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-acesso_',
               'optMulti' => $sc_seq_vert,
                       );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['acesso_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['acesso_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['acesso_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['acesso_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['acesso_' . $sc_seq_vert]['labList'] = $aLabel;
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("insercao_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['insercao_']);
                  $aLookup = array();
$aLookup[] = array(app_form_sec_groups_apps_pack_protect_string('Y') => str_replace('<', '&lt;',app_form_sec_groups_apps_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_insercao_'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['insercao_']) && !empty($this->NM_ajax_info['select_html']['insercao_']))
          {
              eval("\$sOptComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['insercao_']) . "\";");
          }
                  $this->NM_ajax_info['fldList']['insercao_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'checkbox',
                       'switch'  => false,
                       'valList' => explode(';', $sTmpValue),
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-insercao_',
               'optMulti' => $sc_seq_vert,
                       );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['insercao_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['insercao_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['insercao_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['insercao_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['insercao_' . $sc_seq_vert]['labList'] = $aLabel;
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("remocao_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['remocao_']);
                  $aLookup = array();
$aLookup[] = array(app_form_sec_groups_apps_pack_protect_string('Y') => str_replace('<', '&lt;',app_form_sec_groups_apps_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_remocao_'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['remocao_']) && !empty($this->NM_ajax_info['select_html']['remocao_']))
          {
              eval("\$sOptComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['remocao_']) . "\";");
          }
                  $this->NM_ajax_info['fldList']['remocao_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'checkbox',
                       'switch'  => false,
                       'valList' => explode(';', $sTmpValue),
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-remocao_',
               'optMulti' => $sc_seq_vert,
                       );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['remocao_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['remocao_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['remocao_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['remocao_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['remocao_' . $sc_seq_vert]['labList'] = $aLabel;
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("atualizacao_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['atualizacao_']);
                  $aLookup = array();
$aLookup[] = array(app_form_sec_groups_apps_pack_protect_string('Y') => str_replace('<', '&lt;',app_form_sec_groups_apps_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_atualizacao_'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['atualizacao_']) && !empty($this->NM_ajax_info['select_html']['atualizacao_']))
          {
              eval("\$sOptComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['atualizacao_']) . "\";");
          }
                  $this->NM_ajax_info['fldList']['atualizacao_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'checkbox',
                       'switch'  => false,
                       'valList' => explode(';', $sTmpValue),
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-atualizacao_',
               'optMulti' => $sc_seq_vert,
                       );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['atualizacao_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['atualizacao_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['atualizacao_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['atualizacao_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['atualizacao_' . $sc_seq_vert]['labList'] = $aLabel;
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("exportacao_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['exportacao_']);
                  $aLookup = array();
$aLookup[] = array(app_form_sec_groups_apps_pack_protect_string('Y') => str_replace('<', '&lt;',app_form_sec_groups_apps_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_exportacao_'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['exportacao_']) && !empty($this->NM_ajax_info['select_html']['exportacao_']))
          {
              eval("\$sOptComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['exportacao_']) . "\";");
          }
                  $this->NM_ajax_info['fldList']['exportacao_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'checkbox',
                       'switch'  => false,
                       'valList' => explode(';', $sTmpValue),
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-exportacao_',
               'optMulti' => $sc_seq_vert,
                       );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['exportacao_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['exportacao_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['exportacao_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['exportacao_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['exportacao_' . $sc_seq_vert]['labList'] = $aLabel;
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("impressao_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['impressao_']);
                  $aLookup = array();
$aLookup[] = array(app_form_sec_groups_apps_pack_protect_string('Y') => str_replace('<', '&lt;',app_form_sec_groups_apps_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_impressao_'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['impressao_']) && !empty($this->NM_ajax_info['select_html']['impressao_']))
          {
              eval("\$sOptComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['impressao_']) . "\";");
          }
                  $this->NM_ajax_info['fldList']['impressao_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'checkbox',
                       'switch'  => false,
                       'valList' => explode(';', $sTmpValue),
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-impressao_',
               'optMulti' => $sc_seq_vert,
                       );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['impressao_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['impressao_' . $sc_seq_vert]['valList'][$i] = app_form_sec_groups_apps_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['impressao_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['impressao_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['impressao_' . $sc_seq_vert]['labList'] = $aLabel;
              }
          }
   }
...
{
    $original_aplicacao_ = $this->aplicacao_;
}
if (!isset($this->sc_temp_arr_apps)) {$this->sc_temp_arr_apps = (isset($_SESSION['arr_apps'])) ? $_SESSION['arr_apps'] : "";}
 if( isset( $this->sc_temp_arr_apps[ $this->aplicacao_  ] ) )
{
	switch(trim($this->sc_temp_arr_apps[ $this->aplicacao_  ]))
	{
		case 'form':
		break;
		case 'calendar':
			$this->sc_ajax_javascript('nm_field_disabled', array("exportacao_=disabled;impressao_=disabled", "", $sc_seq_vert));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['exportacao_'] = true;
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['impressao_'] = true;
;
		break;
		case 'cons':
			$this->sc_ajax_javascript('nm_field_disabled', array("insercao_=disabled;remocao_=disabled;atualizacao_=disabled", "", $sc_seq_vert));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['insercao_'] = true;
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['remocao_'] = true;
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['atualizacao_'] = true;
;
		break;
		default:
			$this->sc_ajax_javascript('nm_field_disabled', array("insercao_=disabled;remocao_=disabled;atualizacao_=disabled;exportacao_=disabled;impressao_=disabled", "", $sc_seq_vert));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['insercao_'] = true;
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['remocao_'] = true;
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['atualizacao_'] = true;
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['exportacao_'] = true;
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_aplicacao_ != $this->aplicacao_ || (isset($bFlagRead_aplicacao_) && $bFlagRead_aplicacao_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['aplicacao_' . $this->nmgp_refresh_row]['type']    = 'label';
        $this->NM_ajax_info['fldList']['aplicacao_' . $this->nmgp_refresh_row]['valList'] = array($this->aplicacao_);
        $this->NM_ajax_changed['aplicacao_'] = true;
    }
}
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off'; 
          }
...
//----------- 
   ...
   { 
      ...
      {
          $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert];
          if ($this->nmgp_dados_select['aplicacao_'] == $this->aplicacao_ &&
              $this->nmgp_dados_select['acesso_'] == $this->acesso_ &&
              $this->nmgp_dados_select['insercao_'] == $this->insercao_ &&
              $this->nmgp_dados_select['remocao_'] == $this->remocao_ &&
              $this->nmgp_dados_select['atualizacao_'] == $this->atualizacao_ &&
              $this->nmgp_dados_select['exportacao_'] == $this->exportacao_ &&
              $this->nmgp_dados_select['impressao_'] == $this->impressao_)
          { }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['aplicacao_'] = $this->aplicacao_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['acesso_'] = $this->acesso_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['insercao_'] = $this->insercao_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['remocao_'] = $this->remocao_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['atualizacao_'] = $this->atualizacao_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['exportacao_'] = $this->exportacao_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['impressao_'] = $this->impressao_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      $NM_val_form['aplicacao_'] = $this->aplicacao_;
      $NM_val_form['acesso_'] = $this->acesso_;
      $NM_val_form['insercao_'] = $this->insercao_;
      $NM_val_form['remocao_'] = $this->remocao_;
      $NM_val_form['atualizacao_'] = $this->atualizacao_;
      $NM_val_form['exportacao_'] = $this->exportacao_;
      $NM_val_form['impressao_'] = $this->impressao_;
      ...
      {
          $this->aplicacao__before_qstr = $this->aplicacao_;
          $this->aplicacao_ = substr($this->Db->qstr($this->aplicacao_), 1, -1); 
          if ($this->aplicacao_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->aplicacao_ = "null"; 
              $NM_val_null[] = "aplicacao_";
          } 
          $this->acesso__before_qstr = $this->acesso_;
          $this->acesso_ = substr($this->Db->qstr($this->acesso_), 1, -1); 
          if ($this->acesso_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->acesso_ = "null"; 
              $NM_val_null[] = "acesso_";
          } 
          $this->insercao__before_qstr = $this->insercao_;
          $this->insercao_ = substr($this->Db->qstr($this->insercao_), 1, -1); 
          if ($this->insercao_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->insercao_ = "null"; 
              $NM_val_null[] = "insercao_";
          } 
          $this->remocao__before_qstr = $this->remocao_;
          $this->remocao_ = substr($this->Db->qstr($this->remocao_), 1, -1); 
          if ($this->remocao_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->remocao_ = "null"; 
              $NM_val_null[] = "remocao_";
          } 
          $this->atualizacao__before_qstr = $this->atualizacao_;
          $this->atualizacao_ = substr($this->Db->qstr($this->atualizacao_), 1, -1); 
          if ($this->atualizacao_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->atualizacao_ = "null"; 
              $NM_val_null[] = "atualizacao_";
          } 
          $this->exportacao__before_qstr = $this->exportacao_;
          $this->exportacao_ = substr($this->Db->qstr($this->exportacao_), 1, -1); 
          if ($this->exportacao_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->exportacao_ = "null"; 
              $NM_val_null[] = "exportacao_";
          } 
          $this->impressao__before_qstr = $this->impressao_;
          $this->impressao_ = substr($this->Db->qstr($this->impressao_), 1, -1); 
          if ($this->impressao_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->impressao_ = "null"; 
              $NM_val_null[] = "impressao_";
          } 
      }
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where grupo_id = $this->grupo_id_ and aplicacao = '$this->aplicacao_' ";
              $rs1 = $this->Db->Execute("select count(*) AS countTest from " . $this->Ini->nm_tabela . " where grupo_id = $this->grupo_id_ and aplicacao = '$this->aplicacao_' "); 
          }  
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "acesso = '$this->acesso_', insercao = '$this->insercao_', remocao = '$this->remocao_', atualizacao = '$this->atualizacao_', exportacao = '$this->exportacao_', impressao = '$this->impressao_'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $comando .= " WHERE grupo_id = $this->grupo_id_ and aplicacao = '$this->aplicacao_' ";  
              }  
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              {
                  $comando .= " WHERE grupo_id = $this->grupo_id_ and aplicacao = '$this->aplicacao_' ";  
              ...
              $this->aplicacao_ = $this->aplicacao__before_qstr;
              $this->acesso_ = $this->acesso__before_qstr;
              $this->insercao_ = $this->insercao__before_qstr;
              $this->remocao_ = $this->remocao__before_qstr;
              $this->atualizacao_ = $this->atualizacao__before_qstr;
              $this->exportacao_ = $this->exportacao__before_qstr;
              $this->impressao_ = $this->impressao__before_qstr;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['aplicacao_'])) { $this->aplicacao_ = $NM_val_form['aplicacao_']; }
              elseif (isset($this->aplicacao_)) { $this->nm_limpa_alfa($this->aplicacao_); }
              if     (isset($NM_val_form) && isset($NM_val_form['acesso_'])) { $this->acesso_ = $NM_val_form['acesso_']; }
              elseif (isset($this->acesso_)) { $this->nm_limpa_alfa($this->acesso_); }
              if     (isset($NM_val_form) && isset($NM_val_form['insercao_'])) { $this->insercao_ = $NM_val_form['insercao_']; }
              elseif (isset($this->insercao_)) { $this->nm_limpa_alfa($this->insercao_); }
              if     (isset($NM_val_form) && isset($NM_val_form['remocao_'])) { $this->remocao_ = $NM_val_form['remocao_']; }
              elseif (isset($this->remocao_)) { $this->nm_limpa_alfa($this->remocao_); }
              if     (isset($NM_val_form) && isset($NM_val_form['atualizacao_'])) { $this->atualizacao_ = $NM_val_form['atualizacao_']; }
              elseif (isset($this->atualizacao_)) { $this->nm_limpa_alfa($this->atualizacao_); }
              if     (isset($NM_val_form) && isset($NM_val_form['exportacao_'])) { $this->exportacao_ = $NM_val_form['exportacao_']; }
              elseif (isset($this->exportacao_)) { $this->nm_limpa_alfa($this->exportacao_); }
              if     (isset($NM_val_form) && isset($NM_val_form['impressao_'])) { $this->impressao_ = $NM_val_form['impressao_']; }
              elseif (isset($this->impressao_)) { $this->nm_limpa_alfa($this->impressao_); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('aplicacao_', 'acesso_', 'insercao_', 'remocao_', 'atualizacao_', 'exportacao_', 'impressao_'), $aDoNotUpdate);
              $this->nmgp_refresh_fields = $aOldRefresh;

              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {

                  $this->NM_ajax_info['readOnly']['aplicacao_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['acesso_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['insercao_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['remocao_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['atualizacao_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['exportacao_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['impressao_' . $this->nmgp_refresh_row] = 'on';
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (grupo_id, aplicacao, acesso, insercao, remocao, atualizacao, exportacao, impressao) VALUES ($this->grupo_id_, '$this->aplicacao_', '$this->acesso_', '$this->insercao_', '$this->remocao_', '$this->atualizacao_', '$this->exportacao_', '$this->impressao_')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "grupo_id, aplicacao, acesso, insercao, remocao, atualizacao, exportacao, impressao) VALUES (" . $NM_seq_auto . "$this->grupo_id_, '$this->aplicacao_', '$this->acesso_', '$this->insercao_', '$this->remocao_', '$this->atualizacao_', '$this->exportacao_', '$this->impressao_')"; 
              }
              ...
              if (isset($this->Embutida_form) && $this->Embutida_form)
              {
                  ...
                  $tmpLabel_aplicacao_ = $this->aplicacao_;
                  $this->NM_ajax_info['fldList']['aplicacao_' . $this->nmgp_refresh_row]['type']    = 'label';
                  $this->NM_ajax_info['fldList']['aplicacao_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->aplicacao_)));
                  $this->NM_ajax_info['fldList']['aplicacao_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_aplicacao_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['aplicacao_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['aplicacao_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_acesso_'][] = 'Y';
          $sLabelTemp = '';
          $aTemp_acesso_ = explode(';', $this->acesso_);
          foreach ($aTemp_acesso_ as $i => $v)
          {
              $aTemp_acesso_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
              if (in_array(key($aValData), $aTemp_acesso_))
              {
                  if ('' != $sLabelTemp)
                  {
                      $sLabelTemp .= '<br />';
          ...
          $tmpLabel_acesso_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['acesso_' . $this->nmgp_refresh_row]['type']    = 'checkbox';
                  $this->NM_ajax_info['fldList']['acesso_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->acesso_)));
                  $this->NM_ajax_info['fldList']['acesso_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_acesso_);

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['acesso_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['acesso_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_insercao_'][] = 'Y';
          $sLabelTemp = '';
          $aTemp_insercao_ = explode(';', $this->insercao_);
          foreach ($aTemp_insercao_ as $i => $v)
          {
              $aTemp_insercao_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
              if (in_array(key($aValData), $aTemp_insercao_))
              {
                  if ('' != $sLabelTemp)
                  {
                      $sLabelTemp .= '<br />';
          ...
          $tmpLabel_insercao_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['insercao_' . $this->nmgp_refresh_row]['type']    = 'checkbox';
                  $this->NM_ajax_info['fldList']['insercao_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->insercao_)));
                  $this->NM_ajax_info['fldList']['insercao_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_insercao_);

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['insercao_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['insercao_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_remocao_'][] = 'Y';
          $sLabelTemp = '';
          $aTemp_remocao_ = explode(';', $this->remocao_);
          foreach ($aTemp_remocao_ as $i => $v)
          {
              $aTemp_remocao_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
              if (in_array(key($aValData), $aTemp_remocao_))
              {
                  if ('' != $sLabelTemp)
                  {
                      $sLabelTemp .= '<br />';
          ...
          $tmpLabel_remocao_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['remocao_' . $this->nmgp_refresh_row]['type']    = 'checkbox';
                  $this->NM_ajax_info['fldList']['remocao_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->remocao_)));
                  $this->NM_ajax_info['fldList']['remocao_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_remocao_);

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['remocao_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['remocao_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_atualizacao_'][] = 'Y';
          $sLabelTemp = '';
          $aTemp_atualizacao_ = explode(';', $this->atualizacao_);
          foreach ($aTemp_atualizacao_ as $i => $v)
          {
              $aTemp_atualizacao_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
              if (in_array(key($aValData), $aTemp_atualizacao_))
              {
                  if ('' != $sLabelTemp)
                  {
                      $sLabelTemp .= '<br />';
          ...
          $tmpLabel_atualizacao_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['atualizacao_' . $this->nmgp_refresh_row]['type']    = 'checkbox';
                  $this->NM_ajax_info['fldList']['atualizacao_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->atualizacao_)));
                  $this->NM_ajax_info['fldList']['atualizacao_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_atualizacao_);

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['atualizacao_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['atualizacao_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_exportacao_'][] = 'Y';
          $sLabelTemp = '';
          $aTemp_exportacao_ = explode(';', $this->exportacao_);
          foreach ($aTemp_exportacao_ as $i => $v)
          {
              $aTemp_exportacao_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
              if (in_array(key($aValData), $aTemp_exportacao_))
              {
                  if ('' != $sLabelTemp)
                  {
                      $sLabelTemp .= '<br />';
          ...
          $tmpLabel_exportacao_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['exportacao_' . $this->nmgp_refresh_row]['type']    = 'checkbox';
                  $this->NM_ajax_info['fldList']['exportacao_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->exportacao_)));
                  $this->NM_ajax_info['fldList']['exportacao_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_exportacao_);

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['exportacao_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['exportacao_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_impressao_'][] = 'Y';
          $sLabelTemp = '';
          $aTemp_impressao_ = explode(';', $this->impressao_);
          foreach ($aTemp_impressao_ as $i => $v)
          {
              $aTemp_impressao_[$i] = app_form_sec_groups_apps_pack_protect_string(NM_charset_to_utf8($v));
          }
          foreach ($aLookup as $aValData)
          {
              if (in_array(key($aValData), $aTemp_impressao_))
              {
                  if ('' != $sLabelTemp)
                  {
                      $sLabelTemp .= '<br />';
          ...
          $tmpLabel_impressao_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['impressao_' . $this->nmgp_refresh_row]['type']    = 'checkbox';
                  $this->NM_ajax_info['fldList']['impressao_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->impressao_)));
                  $this->NM_ajax_info['fldList']['impressao_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_impressao_);

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['impressao_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['impressao_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
      ...
      { 
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where grupo_id = $this->grupo_id_ and aplicacao = '$this->aplicacao_' "; 
                  $rs = $this->Db->Execute("DELETE FROM " . $this->Ini->nm_tabela . " where grupo_id = $this->grupo_id_ and aplicacao = '$this->aplicacao_' "); 
              }  
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where grupo_id = $this->grupo_id_ and aplicacao = '$this->aplicacao_' "; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['parms'] = "grupo_id_?#?$this->grupo_id_?@?aplicacao_?#?$this->aplicacao_?@?"; 
      }
      if ($this->sc_evento != "insert" && $this->sc_evento != "update" && $this->sc_evento != "delete")
      { 
          $this->grupo_id_ = null === $this->grupo_id_ ? null : substr($this->Db->qstr($this->grupo_id_), 1, -1); 
          $this->aplicacao_ = null === $this->aplicacao_ ? null : substr($this->Db->qstr($this->aplicacao_), 1, -1); 
      } 
   }
//---------- 
   ...
   { 
      ...
      {
          $aNewWhereCond = array();
          if (null != $this->aplicacao_)
          {
              $aNewWhereCond[] = "aplicacao = '" . substr($this->Db->qstr($this->aplicacao_), 1, -1) . "'";
          }
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->grupo_id_) && !empty($this->aplicacao_))
          {
              $Reg_OK      = false;
              $Count_start = -1;
              $sc_order_by = "";
              ...
              $sc_order_by = "grupo_id, aplicacao";
              ...
              while (!$rt->EOF && !$Reg_OK)
              { 
                  if ($rt->fields[0] == $this->grupo_id_ && $rt->fields[1] == $this->aplicacao_)
                  { 
                      $Reg_OK = true;
                  }  
                  $Count_start++;
      ...
      $Cmps_ord_def = array();
      $Cmps_ord_def[] = "aplicacao";
      $Cmps_ord_def[] = "acesso";
      $Cmps_ord_def[] = "insercao";
      $Cmps_ord_def[] = "remocao";
      $Cmps_ord_def[] = "atualizacao";
      $Cmps_ord_def[] = "exportacao";
      $Cmps_ord_def[] = "impressao";
      $sc_order_by  = "";
      $sc_order_by = "grupo_id, aplicacao";
      $sc_order_by = str_replace("order by ", "", $sc_order_by);
      $sc_order_by = str_replace("ORDER BY ", "", trim($sc_order_by));
      ...
      { 
          $nmgp_select = "SELECT grupo_id, aplicacao, acesso, insercao, remocao, atualizacao, exportacao, impressao from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT grupo_id, aplicacao, acesso, insercao, remocao, atualizacao, exportacao, impressao from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      else
      {
          ...
          { 
              ...
              $this->aplicacao_ = $rs->fields[1] ; 
              $this->nmgp_dados_select['aplicacao_'] = $this->aplicacao_;
              $this->acesso_ = $rs->fields[2] ; 
              $this->nmgp_dados_select['acesso_'] = $this->acesso_;
              $this->insercao_ = $rs->fields[3] ; 
              $this->nmgp_dados_select['insercao_'] = $this->insercao_;
              $this->remocao_ = $rs->fields[4] ; 
              $this->nmgp_dados_select['remocao_'] = $this->remocao_;
              $this->atualizacao_ = $rs->fields[5] ; 
              $this->nmgp_dados_select['atualizacao_'] = $this->atualizacao_;
              $this->exportacao_ = $rs->fields[6] ; 
              $this->nmgp_dados_select['exportacao_'] = $this->exportacao_;
              $this->impressao_ = $rs->fields[7] ; 
              $this->nmgp_dados_select['impressao_'] = $this->impressao_;
              $GLOBALS["NM_ERRO_IBASE"] = 0; 
...
<?php
   ...
   else
   {
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("group_id", "app_name", "priv_access", "priv_insert", "priv_delete", "priv_update", "priv_export", "priv_print"))) {
            $searchOk = true;
        }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_insercao_()
   {
       $nmgp_def_dados  = "";
   ...
   function Form_lookup_atualizacao_()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "?#?Y?#??@?";
       $todo = explode("?@?", $nmgp_def_dados);
   ...
   function Form_lookup_exportacao_()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "?#?Y?#??@?";
       $todo = explode("?@?", $nmgp_def_dados);
   ...
   function Form_lookup_impressao_()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "?#?Y?#??@?";
       $todo = explode("?@?", $nmgp_def_dados);
