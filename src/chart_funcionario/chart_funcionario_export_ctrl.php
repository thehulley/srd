<?php
@session_start() ;
$_SESSION['scriptcase']['chart_funcionario']['sc_process_barr'] = true;
require_once('../chart_funcionario/index.php');
unset($_SESSION['scriptcase']['chart_funcionario']['sc_process_barr']);
$ExportCtrl = new chart_funcionario_export_control;
$ExportCtrl->Export_barr();

class chart_funcionario_export_control
{
