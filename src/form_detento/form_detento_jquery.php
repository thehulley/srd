...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_form_detento_id_onchange(this, iSeqRow) });
  $('#id_sc_field_nome' + iSeqRow).bind('blur', function() { sc_form_detento_nome_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_detento_nome_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_data_nascimento' + iSeqRow).bind('blur', function() { sc_form_detento_data_nascimento_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_detento_data_nascimento_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_detento_data_nascimento_onfocus(this, iSeqRow) });
  $('#id_sc_field_data_inicio_pena' + iSeqRow).bind('blur', function() { sc_form_detento_data_inicio_pena_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_detento_data_inicio_pena_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_detento_data_inicio_pena_onfocus(this, iSeqRow) });
  $('#id_sc_field_status_id' + iSeqRow).bind('blur', function() { sc_form_detento_status_id_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_detento_status_id_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_detento_status_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_data' + iSeqRow).bind('blur', function() { sc_form_detento_data_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_detento_data_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_detento_data_onfocus(this, iSeqRow) });
  $('#id_sc_field_data_hora' + iSeqRow).bind('blur', function() { sc_form_detento_data_hora_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_detento_data_hora_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_detento_data_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_crimes' + iSeqRow).bind('blur', function() { sc_form_detento_crimes_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_detento_crimes_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_detento_crimes_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_detento_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_detento_nome_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detento_nome_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detento_matricula_onblur(oThis, iSeqRow) {
...
function sc_form_detento_data_nascimento_onblur(oThis, iSeqRow) {
  do_ajax_form_detento_validate_data_nascimento();
  scCssBlur(oThis);
}

function sc_form_detento_data_nascimento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detento_data_nascimento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detento_data_inicio_pena_onblur(oThis, iSeqRow) {
  do_ajax_form_detento_validate_data_inicio_pena();
  scCssBlur(oThis);
}

function sc_form_detento_data_inicio_pena_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detento_data_inicio_pena_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detento_status_id_onblur(oThis, iSeqRow) {
  do_ajax_form_detento_validate_status_id();
  scCssBlur(oThis);
}

function sc_form_detento_status_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detento_status_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detento_data_onblur(oThis, iSeqRow) {
  do_ajax_form_detento_validate_data();
  scCssBlur(oThis);
}

function sc_form_detento_data_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_detento_validate_data();
  scCssBlur(oThis);
}

function sc_form_detento_data_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detento_data_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detento_data_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detento_data_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_detento_crimes_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_detento_form" + pageNo).hide();
}
...
?>
  ...
  $("#id_sc_field_data" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_detento_validate_data(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_detento')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
