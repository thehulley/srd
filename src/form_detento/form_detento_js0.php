...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_detento']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_detento"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var Crtl_btn_Soltura = false;
function sc_btn_Soltura()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_Soltura(); }, 500);
      return;
    }
...
function sc_btn_Soltura_ok()
{
    Crtl_btn_Soltura = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?Soltura?@?";
    document.F1.action = "./";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detento']['where_detal']))
  {
?>  
