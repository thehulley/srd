  ...
  if(isset($_GET['a']) && substr($_GET['a'],0,4) == 'new_')
{
     ...
     $nm_select ="UPDATE funcionario SET ativo = 'Y', codigo_ativacao ='' WHERE codigo_ativacao = ". $this->Db->qstr($_GET['a']); 
...
//---------------------------------------------------------
    ...
    function ValidateField_matricula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if (($this->nmgp_opcao == "incluir" || 'validate_matricula' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['php_cmp_required']['matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['php_cmp_required']['matricula'] == "on"))
      { 
          if ($this->matricula == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_senha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (($this->nmgp_opcao == "incluir" || 'validate_senha' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['php_cmp_required']['senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['php_cmp_required']['senha'] == "on"))
      { 
          if ($this->senha == "")  
          { 
              $hasError = true;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['matricula']['keyVal'] = app_form_add_users_mob_pack_protect_string($this->nmgp_dados_form['matricula']);
          }
   } // ajax_return_values
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      {
          if (!isset($this->nmgp_cmp_hidden["matricula"]))
          {
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          {
               $sc_where_pos = " WHERE ((matricula < '" . substr($this->Db->qstr($this->matricula), 1, -1) . "'))";
               if ('' != $sc_where)
               {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('matricula', 'senha', 'confirm_pswd', 'nome', 'email'), $aDoNotUpdate);
              $this->ajax_return_values();
...
$_SESSION['scriptcase']['app_form_add_users_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['parms'] = "matricula?#?$this->matricula?@?"; 
      }
      $this->NM_commit_db(); 
...
$_SESSION['scriptcase']['app_form_add_users_mob']['contr_erro'] = 'on';
	...
	$sql = "INSERT INTO
				grupo_usuario( funcionario, grupo_id )
			VALUES 
				(". $this->Db->qstr($login). ", ".
...
$update_sql = 'UPDATE funcionario'
    . ' SET codigo_ativacao = ' . $this->Db->qstr($act_code)
    . ' WHERE matricula = '. $this->Db->qstr($this->matricula );
