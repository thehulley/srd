...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate descricao
  function do_ajax_app_form_sec_groups_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_groups_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_app_form_sec_groups_mob_validate_descricao_cb);
  } // do_ajax_app_form_sec_groups_mob_validate_descricao

  function do_ajax_app_form_sec_groups_mob_validate_descricao_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_mob_validate_descricao_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_sec_groups_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_groups_mob_submit_form(var_descricao, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_sec_groups_mob_submit_form_cb);
...
?>
  ...
  function perform_ajax_app_form_sec_groups_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_groups_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_sec_groups_mob_navigate_form_cb);
